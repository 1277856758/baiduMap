/**
 * @fileoverview 鐧惧害鍦板浘鐨勭儹鍔涘浘鍔熻兘,瀵瑰寮€鏀俱€�
 * 涓昏鍩轰簬http://www.patrick-wied.at/static/heatmapjs/index.html 淇敼鑰屽緱


/*==============================浠ヤ笅閮ㄥ垎涓篽eatmap.js鐨勬牳蹇冧唬鐮�,鍙礋璐ｇ儹鍔涘浘鐨勫睍鐜�, 浠ｇ爜鏉ヨ嚜绗笁鏂�==================================== */
    ...
    var heatmapFactory = (function () {
        ...
        heatmap.prototype = {
            ...
            drawAlpha: function (x, y, count, colorize) {
                ...
                console.log('rgba(0,0,0,' + ((count) ? (count / me.store.max) : '0.1') + ')');
...
/* ==============================浠ヤ笂閮ㄥ垎涓篽eatmap.js鐨勬牳蹇冧唬鐮�,鍙礋璐ｇ儹鍔涘浘鐨勫睍鐜�==================================== */


/* ==============================浠ヤ笅閮ㄥ垎涓轰笓涓虹櫨搴﹀湴鍥炬墦閫犵殑瑕嗙洊鐗�=================================================== */
/**
 * @fileoverview 鐧惧害鍦板浘鐨勭儹鍔涘浘鍔熻兘,瀵瑰寮€鏀俱€�
 * 涓昏鍩轰簬http://www.patrick-wied.at/static/heatmapjs/index.html 淇敼鑰屽緱

 * 涓诲叆鍙ｇ被鏄�<a href="symbols/BMapLib.Heatmap.html">Heatmap</a>锛�
 * 鍩轰簬Baidu Map API 2.0銆�
 *
...
(function () {
     ...
     * 鐑姏鍥剧殑瑕嗙洊鐗�
     * @class 鐑姏鍥剧殑瑕嗙洊鐗�
     * 瀹炰緥鍖栬绫诲悗锛屼娇鐢╩ap.addOverlay鍗冲彲浠ユ坊鍔犲娍鍔涘浘
     *
     * @constructor
     * @param {Json Object} opts 鍙€夌殑杈撳叆鍙傛暟锛岄潪蹇呭～椤广€傚彲杈撳叆閫夐」鍖呮嫭锛�<br />
     * {"<b>radius</b>" : {String} 鐑姏鍥剧殑鍗婂緞,
     * <br />"<b>visible</b>" : {Number} 鐑姏鍥炬槸鍚︽樉绀�,
     * <br />"<b>gradient</b>" : {JSON} 鐑姏鍥剧殑娓愬彉鍖洪棿,
     * <br />"<b>opacity</b>" : {Number} 鍔垮姏鐨勯€忔槑搴�,
     *
     * @example <b>鍙傝€冪ず渚嬶細</b><br />
     * var map = new BMap.Map("container");<br />map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />var heatmapOverlay = new BMapLib.HeatmapOverlay({"radius":10, "visible":true, "opacity":70});<br />heatmapOverlay.setDataSet(data);//data鏄儹鍔涘浘鐨勮缁嗘暟鎹�
     */
    ...
    BMapLib.HeatmapOverlay = HeatmapOverlay; // 鍚戝懡鍚嶇┖闂存敞鍐�.
})();
