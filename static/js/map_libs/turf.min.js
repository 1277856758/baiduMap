!(function (t, e) {
    typeof exports === 'object' && typeof module !== 'undefined' ? e(exports) : typeof define === 'function' && define.amd ? define(['exports'], e) : e(t.turf = {});
}(this, function (t) {
    'use strict';
    ...
    function o (t, n, r) {
        ...
        for (var i = 0; i < t.length; i++) {
            ...
            for (var s = 0; s < o[o.length - 1].length; s++) {
                if (i === 0 && s === 0 && !b(o[0][0]) || !b(o[0][1])) throw new Error('coordinates must contain numbers');
    ...
    function g (t, e) {
        if (void 0 === t || t === null || isNaN(t)) throw new Error('num is required');
    ...
    function d (t, e) {
        if (void 0 === t || t === null) throw new Error('radians is required');
        if (e && typeof e !== 'string') throw new Error('units must be a string');
    ...
    function y (t, e) {
        if (void 0 === t || t === null) throw new Error('distance is required');
        if (e && typeof e !== 'string') throw new Error('units must be a string');
        var n = qo[e || 'kilometers'];
        if (!n) throw new Error(e + ' units is invalid');
        return t / n;
    ...
    function m (t) {
        if (t === null || void 0 === t) throw new Error('bearing is required');
        var e = t % 360;
        return e < 0 && (e += 360), e;
    }

    function v (t) {
        if (t === null || void 0 === t) throw new Error('radians is required');
        return 180 * (t % (2 * Math.PI)) / Math.PI;
    }

    function x (t) {
        if (t === null || void 0 === t) throw new Error('degrees is required');
        return t % 360 * Math.PI / 180;
    }

    function E (t, e, n) {
        if (t === null || void 0 === t) throw new Error('length is required');
        if (!(t >= 0)) throw new Error('length must be a positive number');
        return d(y(t, e), n || 'kilometers');
    }

    function w (t, e, n) {
        if (t === null || void 0 === t) throw new Error('area is required');
    ...
    function S (t, e, n) {
        if (t !== null) {
            for (var r, i, o, s, a, u, c, h, l = 0, p = 0, f = t.type, g = f === 'FeatureCollection', d = f === 'Feature', y = g ? t.features.length : 1, _ = 0; _ < y; _++) {
                a = (h = !!(c = g ? t.features[_].geometry : d ? t.geometry : t) && c.type === 'GeometryCollection') ? c.geometries.length : 1;
                for (var m = 0; m < a; m++) {
                    var v = 0,
                        x = 0;
                    if ((s = h ? c.geometries[m] : c) !== null) {
                        u = s.coordinates;
                        var E = s.type;
                        switch (l = !n || E !== 'Polygon' && E !== 'MultiPolygon' ? 0 : 1, E) {
                        case null:
                            break;
                        case 'Point':
                            e(u, p, _, v, x), p++, v++;
                        ...
                        case 'LineString':
                        case 'MultiPoint':
                            for (r = 0; r < u.length; r++) e(u[r], p, _, v, x), p++, E === 'MultiPoint' && v++;
                            E === 'LineString' && v++;
                            break;
                        case 'Polygon':
                        case 'MultiLineString':
                            for (r = 0; r < u.length; r++) {
                                ...
                                E === 'MultiLineString' && v++, E === 'Polygon' && x++;
                            }
                            E === 'Polygon' && v++;
                            break;
                        case 'MultiPolygon':
                            for (r = 0; r < u.length; r++) {
                                for (E === 'MultiPolygon' && (x = 0), i = 0; i < u[r].length; i++) {
    ...
    function M (t, e, n, r) {
        ...
        return S(t, function (t, r, o, s, a) {
            i = r === 0 && void 0 === n ? t : e(i, t, r, o, s, a);
        }, r), i;
    }
    ...
    function A (t, e) {
        var n, r, i, o, s, a, u, c, h, l, p = 0,
            f = t.type === 'FeatureCollection',
            g = t.type === 'Feature',
            d = f ? t.features.length : 1;
        for (n = 0; n < d; n++) {
            for (a = f ? t.features[n].geometry : g ? t.geometry : t, c = f ? t.features[n].properties : g ? t.properties : {}, h = f ? t.features[n].bbox : g ? t.bbox : void 0, l = f ? t.features[n].id : g ? t.id : void 0, s = (u = !!a && a.type === 'GeometryCollection') ? a.geometries.length : 1, i = 0; i < s; i++) {
                if ((o = u ? a.geometries[i] : a) !== null) {
                    switch (o.type) {
                    case 'Point':
                    case 'LineString':
                    case 'MultiPoint':
    ...
    function D (t, e, n) {
        ...
        return A(t, function (t, i, o, s, a) {
            r = i === 0 && void 0 === n ? t : e(r, t, i, o, s, a);
        }), r;
    }
    ...
    function q (t, e, n) {
        ...
        return F(t, function (t, i, o) {
            r = i === 0 && o === 0 && void 0 === n ? t : e(r, t, i, o);
        }), r;
    }
    ...
    function G (t, e) {
        F(t, function (t, n, r) {
            ...
            if (t.geometry) {
                ...
                o !== 'Point' && o !== 'MultiPoint' && M(t, function (o, s, u, c, h, l) {
    ...
    function H (t, e, n) {
        ...
        if (!t || t.type !== 'Feature' || !t.geometry) throw new Error('Invalid input to ' + n + ', Feature with geometry required');
    ...
    function W (t, e, n) {
        ...
        if (!t || t.type !== 'FeatureCollection') throw new Error('Invalid input to ' + n + ', FeatureCollection required');
        for (var r = 0; r < t.features.length; r++) {
            var i = t.features[r];
            if (!i || i.type !== 'Feature' || !i.geometry) throw new Error('Invalid input to ' + n + ', Feature with geometry required');
    ...
    function Q (t, e, n) {
        ...
        for (var r = Object.keys(Xo), i = 0; i < r.length; i++) {
            var o = r[i],
                s = n[o];
            s = void 0 !== s && s !== null ? s : Xo[o], Uo[o] = s;
        }
                    ...
                    if (void 0 !== r && !(function (t) {
                        ...
                        var s = (function (t, e, n) {
                                ...
                                for (var g = n + u[p], d = e + c[p], y = p; g >= 0 && d >= 0 && d < s && (g != n || d != e) && void 0 !== (l = t[d][g]);) {
                                    ...
                                    o = h[p], r = u[p], i = c[p], p !== 5 && p !== 10 || (p === 5 ? l.flipped ? c[y] === -1 ? (o = 'left', r = -1, i = 0) : (o = 'right', r = 1, i = 0) : u[y] === -1 && (o = 'bottom', r = 0, i = -1) : p === 10 && (l.flipped ? u[y] === -1 ? (o = 'top', r = 0, i = 1) : (o = 'bottom', r = 0, i = -1) : c[y] === 1 && (o = 'left', r = -1, i = 0))), f = nt(l, o), a.push([g + f[0], d + f[1]]), et(l), g += r, d += i, y = p;
                                }
                                return {
                                    path: a,
                                    info: 'closed'
            ...
            for (var n = t.length - 1, r = t[0].length - 1, i = {
                ...
                for (var s = 0; s < r; ++s) {
                    ...
                    if (!(isNaN(u) || isNaN(c) || isNaN(h) || isNaN(l))) {
                        ...
                        if ((a |= l >= e ? 1 : 0) === 5 || a === 10) {
                            var f = (u + c + h + l) / 4;
                            a === 5 && f < e ? (a = 10, p = !0) : a === 10 && f < e && (a = 5, p = !0);
                        }
                        if (a !== 0 && a !== 15) {
                            var g, d, y, _;
                            g = d = y = _ = 0.5, a === 1 ? (y = 1 - $(e, u, l), d = 1 - $(e, h, l)) : a === 2 ? (d = $(e, l, h), _ = 1 - $(e, c, h)) : a === 3 ? (y = 1 - $(e, u, l), _ = 1 - $(e, c, h)) : a === 4 ? (g = $(e, u, c), _ = $(e, h, c)) : a === 5 ? (g = $(e, u, c), _ = $(e, h, c), d = 1 - $(e, h, l), y = 1 - $(e, u, l)) : a === 6 ? (d = $(e, l, h), g = $(e, u, c)) : a === 7 ? (y = 1 - $(e, u, l), g = $(e, u, c)) : a === 8 ? (y = $(e, l, u), g = 1 - $(e, c, u)) : a === 9 ? (d = 1 - $(e, h, l), g = 1 - $(e, c, u)) : a === 10 ? (g = 1 - $(e, c, u), _ = 1 - $(e, c, h), d = $(e, l, h), y = $(e, l, u)) : a === 11 ? (g = 1 - $(e, c, u), _ = 1 - $(e, c, h)) : a === 12 ? (y = $(e, l, u), _ = $(e, h, c)) : a === 13 ? (d = 1 - $(e, h, l), _ = $(e, h, c)) : a === 14 ? (y = $(e, l, u), d = $(e, l, h)) : console.log('MarchingSquaresJS-isoContours: Illegal cval detected: ' + a), i.cells[o][s] = {
                                cval: a,
                                flipped: p,
                                top: g,
                                right: _,
        ...
        return typeof Uo.successCallback === 'function' && Uo.successCallback(a), a;
    }
    ...
    function tt (t) {
        return t.cval === 0 || t.cval === 15;
    }

    function et (t) {
        tt(t) || t.cval === 5 || t.cval === 10 || (t.cval = 15);
    }

    function nt (t, e) {
        return e === 'top' ? [t.top, 1] : e === 'bottom' ? [t.bottom, 0] : e === 'right' ? [1, t.right] : e === 'left' ? [0, t.left] : void 0;
    }
    ...
    function it (t, e, n, r, i) {
        for (n = n || 0, r = r || t.length - 1, i = i || function (t, e) {
            ...
            i(t[n], h) === 0 ? ot(t, n, p) : ot(t, ++p, r), p <= e && (n = p + 1), e <= p && (r = p - 1);
        }
    }
    ...
    function st (t, e) {
        ...
        this._maxEntries = Math.max(4, t || 9), this._minEntries = Math.max(2, Math.ceil(0.4 * this._maxEntries)), e && this._initFormat(e), this.clear();
    }
    ...
    function Mt (t, e, n, r, i, o, s, a) {
        var u, c, h, l, p = n - t,
            ...
            I = b,
            N = b;
        b === 0 ? (c = 0, I = 1, l = w, N = x) : (l = m * w - v * E, (c = v * w - x * E) < 0 ? (c = 0, l = w, N = x) : c > I && (c = I, l = w + v, N = x)), l < 0 ? (l = 0, -E < 0 ? c = 0 : -E > m ? c = I : (c = -E, I = m)) : l > N && (l = N, -E + v < 0 ? c = 0 : -E + v > m ? c = I : (c = -E + v, I = m)), u = c === 0 ? 0 : c / I;
        var C = (1 - (h = l === 0 ? 0 : l / N)) * i + h * s - ((1 - u) * t + u * n),
    ...
    function Pt (t, e, n) {
        if (typeof (n = n || {}) !== 'object') throw new Error('options is invalid');
    ...
    function Tt (t, e) {
        if (t.type !== 'FeatureCollection') throw new Error('points must be a FeatureCollection');
        var n = !1;
        return c((function (t) {
            ...
            return e ? r.z = t.properties[e] : t.geometry.coordinates.length === 3 && (n = !0, r.z = t.geometry.coordinates[2]), r;
        }))).map(function (t) {
            var e = [t.a.x, t.a.y],
                r = [t.b.x, t.b.y],
                i = [t.c.x, t.c.y],
    ...
    function kt (t) {
        ...
        return t ? (Object.keys(t).forEach(function (n) {
            var r = t[n];
            typeof r === 'object' ? r === null ? e[n] = null : r.length ? e[n] = r.map(function (t) {
                return t;
            }) : e[n] = kt(r) : e[n] = r;
        }), e) : e;
    }
    ...
    function zt (t) {
        ...
        return t.bbox && (e.bbox = t.bbox), t.type === 'GeometryCollection' ? (e.geometries = t.geometries.map(function (t) {
            return zt(t);
        }), e) : (e.coordinates = jt(t.coordinates), e);
    }

    function jt (t) {
        return typeof t[0] !== 'object' ? t.slice() : t.map(function (t) {
            return jt(t);
        });
    }
    ...
    function Ut (t, e) {
        ...
        return e.forEach(n), s.forEach(function (t) {
            ...
            arcs: a.map(function (e) {
                ...
                }), r = ls(t, r), (n = r.length) > 1) {
                    for (var s, a, u = 1, c = i(r[0]); u < n; ++u)(s = i(r[u])) > c && (a = r[0], r[0] = r[u], r[u] = a, c = s);
                }
                return r;
            })
        };
    ...
    function Vt (t) {
        return t == null ? {
            type: null
        } : (t.type === 'FeatureCollection' ? function (t) {
            var e = {
                type: 'GeometryCollection',
                geometries: t.features.map(Ht)
            };
            t.bbox != null && (e.bbox = t.bbox);
            return e;
        } : t.type === 'Feature' ? Ht : Wt)(t);
    }

    function Ht (t) {
        var e, n = Wt(t.geometry);
        t.id != null && (n.id = t.id), t.bbox != null && (n.bbox = t.bbox);
    ...
    function Wt (t) {
        ...
        var e = t.type === 'GeometryCollection' ? {
            type: 'GeometryCollection',
            geometries: t.geometries.map(Wt)
        } : t.type === 'Point' || t.type === 'MultiPoint' ? {
            type: t.type,
    ...
    function Kt (t, e) {
        if (e = e || {}, !I(e)) throw new Error('options is invalid');
        var n = e.mutate;
        if (K(t) !== 'FeatureCollection') throw new Error('geojson must be a FeatureCollection');
        ...
        return i && r.push(i), r.length ? r.length === 1 ? r[0] : h(r.map(function (t) {
    ...
    function te (t, n) {
        var r = typeof n === 'object' ? n.mutate : n;
        if (!t) throw new Error('geojson is required');
        var i = K(t),
            o = [];
        switch (i) {
        ...
        return t.map(function (t) {
            ...
            for (var i = oe(r, e, n).map(function (t) {
                return [t.x, t.y];
                    ...
                    return !(t.length < 3 || t.length === 3 && t[2][0] === t[0][0] && t[2][1] === t[0][1]);
                }(i));) {
    ...
    function fe (t, e, n) {
        ...
        if (typeof r !== 'number') throw new Error('steps must be a number');
    ...
    function me (t) {
        var e = [];
        return t.type === 'FeatureCollection' ? O(t, function (t) {
            S(t, function (n) {
    ...
    function ve (t, e, n) {
        ...
        if (r && (o = (function (t, e, n, r) {
            ...
            for (i = 0, o = e.length; i < o; i++) {
                s = e[i] * r, a = i < o - 1 ? e[i + 1] * r : t.length, (u = xe(t, s, a, r, !1)) === u.next && (u.steiner = !0), c.push(function (t) {
                    var e = t,
                        n = t;
                    do {
    ...
    function xe (t, e, n, r, i) {
        ...
        if (i === Ae(t, e, n, r) > 0) {
            ...
            for (o = n - r; o >= e; o -= r) s = Oe(o, t[o], t[o + 1], s);
        }
    ...
    function Ee (t, e) {
        ...
        var n, r = t;
        do {
            if (n = !1, r.steiner || !Se(r, r.next) && Ce(r.prev, r, r.next) !== 0) r = r.next;
            else {
    ...
    function we (t, e, n, r, i, o, s) {
        if (t) {
            !s && o && (function (t, e, n, r) {
                var i = t;
                do {
                    i.z === null && (i.z = Ie(i.x, i.y, e, n, r)), i.prevZ = i.prev, i.nextZ = i.next, i = i.next;
                } while (i !== t);
                ...
                (function (t) {
                    ...
                    do {
                        for (n = t, t = null, o = null, s = 0; n;) {
                            ...
                            for (u = c; a > 0 || u > 0 && r;) a !== 0 && (u === 0 || !r || n.z <= r.z) ? (i = n, n = n.nextZ, a--) : (i = r, r = r.nextZ, u--), o ? o.nextZ = i : t = i, i.prevZ = o, o = i;
                            n = r;
                        }
                        o.nextZ = null, c *= 2;
                    } while (s > 1);
            ...
            for (var a, u, c = t; t.prev !== t.next;) {
                if (a = t.prev, u = t.next, o ? (function (t, e, n, r) {
                    var i = t.prev,
                        o = t,
                        s = t.next;
                    ...
                    return !0;
                }(t))) e.push(a.i / n), e.push(t.i / n), e.push(u.i / n), Re(t), t = u.next, c = u.next;
                else if ((t = u) === c) {
                    s ? s === 1 ? we(t = (function (t, e, n) {
                        var r = t;
                        do {
                            var i = r.prev,
                                o = r.next.next;
                        ...
                        return r;
                    }(t, e, n)), e, n, r, i, o, 2) : s === 2 && (function (t, e, n, r, i, o) {
                        var s = t;
                        do {
    ...
    function Ge (t, e, n, r, i) {
        for (; r > n;) {
            ...
            i(t[n], h) === 0 ? Be(t, n, p) : Be(t, ++p, r), p <= e && (n = p + 1), e <= p && (r = p - 1);
        }
    }
    ...
    function Qe (t) {
        ...
        return e.insert = function (t) {
            ...
            var e;
            return e = t.bbox ? t.bbox : Array.isArray(t) && t.length === 4 ? t : tn(t), {
                minX: e[0],
                minY: e[1],
                maxX: e[2],
                maxY: e[3]
    ...
    function nn (t, n) {
        var r = {},
            i = [];
        if (t.type === 'LineString' && (t = e(t)), n.type === 'LineString' && (n = e(n)), t.type === 'Feature' && n.type === 'Feature' && t.geometry.type === 'LineString' && n.geometry.type === 'LineString' && t.geometry.coordinates.length === 2 && n.geometry.coordinates.length === 2) {
            var o = rn(t, n);
    ...
    function rn (t, e) {
        var n = U(t),
            i = U(e);
        if (n.length !== 2) throw new Error('<intersects> line1 must only contain 2 coordinates');
    ...
    function on (t, e, n) {
        ...
        if (i !== 'LineString' && i !== 'MultiLineString') throw new Error('lines must be LineString or MultiLineString');
        var o = r([1 / 0, 1 / 0], {
                dist: 1 / 0
            }),
            s = 0;
    ...
    function ln (t, e, n) {
        ...
        var r = n.mutate;
        if (!t) throw new Error('geojson is required');
        return Array.isArray(t) && b(t[0]) ? t = e === 'mercator' ? pn(t) : fn(t) : (!0 !== r && (t = Gt(t)), S(t, function (t) {
            var n = e === 'mercator' ? pn(t) : fn(t);
            t[0] = n[0], t[1] = n[1];
        })), t;
    }
    ...
    function pn (t) {
        var e = Math.PI / 180,
            ...
            }(t[0]))) * e, 6378137 * Math.log(Math.tan(0.25 * Math.PI + 0.5 * t[1] * e))];
    ...
    function gn (t, n, i) {
        ...
        if (Array.isArray(t) ? t = r(t) : t.type === 'Point' ? t = e(t) : H(t, 'Point', 'point'), !n) throw new Error('line is required');
        Array.isArray(n) ? n = a(n) : n.type === 'LineString' ? n = e(n) : H(n, 'LineString', 'line');
        var o = 1 / 0,
    ...
    function yn (t) {
        for (var n = (function (t) {
                if (t.type !== 'FeatureCollection') return t.type !== 'Feature' ? c([e(t)]) : c([t]);
                return t;
            }(t)), i = de(n), o = !1, s = 0; !o && s < n.features.length;) {
            var a, u = n.features[s].geometry,
                h = !1;
            if (u.type === 'Point') i.geometry.coordinates[0] === u.coordinates[0] && i.geometry.coordinates[1] === u.coordinates[1] && (o = !0);
            else if (u.type === 'MultiPoint') {
                var l = !1;
            ...
            else if (u.type === 'MultiLineString') {
            ...
            else u.type !== 'Polygon' && u.type !== 'MultiPolygon' || Pt(i, u) && (o = !0);
            s++;
        }
        if (o) return i;
        var g = c([]);
    ...
    function In (t, e, n, r) {
        ...
        var i, o = [];
        if (t.type === 'Feature') i = t.geometry.coordinates;
        else {
            if (t.type !== 'LineString') throw new Error('input must be a LineString Feature or Geometry');
            i = t.coordinates;
        }
    ...
    function Nn (t, e, n) {
        ...
        for (var i = X(t), o = U(e), s = 0; s < o.length - 1; s++) {
            var a = !1;
            if (r && (s === 0 && (a = 'start'), s === o.length - 2 && (a = 'end'), s === 0 && s + 1 === o.length - 1 && (a = 'both')), (function (t, e, n, r) {
                var i = n[0],
                    o = n[1],
                    s = t[0],
                    a = t[1],
                ...
                if (h * f - l * p != 0) return !1; {
                    ...
                    if (r === 'start') return Math.abs(p) >= Math.abs(f) ? p > 0 ? s < i && i <= u : u <= i && i < s : f > 0 ? a < o && o <= c : c <= o && o < a;
                    if (r === 'end') return Math.abs(p) >= Math.abs(f) ? p > 0 ? s <= i && i < u : u < i && i <= s : f > 0 ? a <= o && o < c : c < o && o <= a;
                    if (r === 'both') return Math.abs(p) >= Math.abs(f) ? p > 0 ? s < i && i < u : u < i && i < s : f > 0 ? a < o && o < c : c < o && o < a;
                }
    ...
    function Ln (t, e, n) {
        ...
        var i = n.mask,
            o = n.properties,
            s = [];
        if (e === null || void 0 === e) throw new Error('cellSide is required');
        if (!b(e)) throw new Error('cellSide is invalid');
        if (!t) throw new Error('bbox is required');
        if (!Array.isArray(t)) throw new Error('bbox must be array');
        if (t.length !== 4) throw new Error('bbox must contain 4 numbers');
        if (i && ['Polygon', 'MultiPolygon'].indexOf(K(i)) === -1) throw new Error('options.mask must be a (Multi)Polygon');
    ...
    function Pn (t, e) {
        ...
        var n = e.precision,
            r = e.coordinates,
            i = e.mutate;
        if (n = void 0 === n || n === null || isNaN(n) ? 6 : n, r = void 0 === r || r === null || isNaN(r) ? 3 : r, !t) throw new Error('<geojson> is required');
    ...
    function Rn (t, e) {
        if (void 0 === e && (e = !0), t.length != 3) throw new Error('This function requires an array of three points [x,y]');
    ...
    function Gn (t, e, n, r, i) {
        ...
        if (!t) throw new Error('center is required');
        if (!e) throw new Error('radius is required');
        if (void 0 === n || n === null) throw new Error('bearing1 is required');
        if (void 0 === r || r === null) throw new Error('bearing2 is required');
    ...
    function Zn (t, e, n) {
        return n || (n = {}), t === e || (t instanceof Date && e instanceof Date ? t.getTime() === e.getTime() : !t || !e || typeof t !== 'object' && typeof e !== 'object' ? (n.strict, t === e) : (function (t, e, n) {
            var r, i;
            ...
            for (o.sort(), s.sort(), r = o.length - 1; r >= 0; r--) {
                if (o[r] !== s[r]) return !1;
            }
            for (r = o.length - 1; r >= 0; r--) {
                if (i = o[r], !Zn(t[i], e[i], n)) return !1;
            }
        ...
        return G(e, function (t) {
            ...
            O(o.search(t), function (n) {
                if (!1 === e) {
                    var i = U(t).sort(),
                        o = U(n).sort();
                    Zn(i, o) ? (e = !0, s = s ? tr(s, t) : t) : (r === 0 ? Nn(i[0], n) && Nn(i[1], n) : on(n, i[0]).properties.dist <= r && on(n, i[1]).properties.dist <= r) ? (e = !0, s = s ? tr(s, t) : t) : (r === 0 ? Nn(o[0], t) && Nn(o[1], t) : on(t, o[0]).properties.dist <= r && on(t, o[1]).properties.dist <= r) && (s = s ? tr(s, n) : n);
                }
    ...
    function nr (t, e, n, i) {
        ...
        if (void 0 === e || e === null) throw new Error('distance is required');
        if (void 0 === n || n === null) throw new Error('bearing is required');
    ...
    function or (t) {
        ...
        if (!Array.isArray(t) && e !== 'LineString') throw new Error('geometry must be a LineString');
    ...
    function hr (t, e, n, r) {
        ...
        for (var i = Object.keys(ks), o = 0; o < i.length; o++) {
            var s = i[o],
                a = r[s];
            a = void 0 !== a && a !== null ? a : ks[s], zs[s] = a;
        }
                ...
                for (var u = 0; u < i; ++u) {
                    ...
                    if (!(isNaN(h) || isNaN(l) || isNaN(p) || isNaN(f))) {
                        ...
                        var g = +(c |= f < e ? 0 : f > s ? 2 : 1),
                            d = 0;
                        if (c === 17 || c === 18 || c === 33 || c === 34 || c === 38 || c === 68 || c === 72 || c === 98 || c === 102 || c === 132 || c === 136 || c === 137 || c === 152 || c === 153) {
                            var y = (h + l + p + f) / 4;
                            d = y > s ? 2 : y < e ? 0 : 1, c === 34 ? d === 1 ? c = 35 : d === 0 && (c = 136) : c === 136 ? d === 1 ? (c = 35, d = 4) : d === 0 && (c = 34) : c === 17 ? d === 1 ? (c = 155, d = 4) : d === 0 && (c = 153) : c === 68 ? d === 1 ? (c = 103, d = 4) : d === 0 && (c = 102) : c === 153 ? d === 1 && (c = 155) : c === 102 ? d === 1 && (c = 103) : c === 152 ? d < 2 && (c = 156, d = 1) : c === 137 ? d < 2 && (c = 139, d = 1) : c === 98 ? d < 2 && (c = 99, d = 1) : c === 38 ? d < 2 && (c = 39, d = 1) : c === 18 ? d > 0 ? (c = 156, d = 4) : c = 152 : c === 33 ? d > 0 ? (c = 139, d = 4) : c = 137 : c === 72 ? d > 0 ? (c = 99, d = 4) : c = 98 : c === 132 && (d > 0 ? (c = 39, d = 4) : c = 38);
                        }
                        if (c != 0 && c != 170) {
                            var _, m, v, x, E, w, b, I;
                            _ = m = v = x = E = w = b = I = 0.5;
                            var N = [];
                            c === 1 ? (v = 1 - lr(e, p, f), I = 1 - lr(e, h, f), N.push(Sa[c])) : c === 169 ? (v = lr(s, f, p), I = lr(s, f, h), N.push(Sa[c])) : c === 4 ? (w = 1 - lr(e, l, p), x = lr(e, f, p), N.push(Na[c])) : c === 166 ? (w = lr(s, p, l), x = 1 - lr(s, p, f), N.push(Na[c])) : c === 16 ? (E = lr(e, p, l), m = lr(e, h, l), N.push(Ia[c])) : c === 154 ? (E = 1 - lr(s, l, p), m = 1 - lr(s, l, h), N.push(Ia[c])) : c === 64 ? (b = lr(e, f, h), _ = 1 - lr(e, l, h), N.push(La[c])) : c === 106 ? (b = 1 - lr(s, h, f), _ = lr(s, h, l), N.push(La[c])) : c === 168 ? (x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), N.push(Ca[c]), N.push(Sa[c])) : c === 2 ? (x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), N.push(Ca[c]), N.push(Sa[c])) : c === 162 ? (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), N.push(Ca[c]), N.push(Sa[c])) : c === 8 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), N.push(Ia[c]), N.push(Na[c])) : c === 138 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Ia[c]), N.push(Na[c])) : c === 32 ? (E = lr(s, p, l), w = lr(e, p, l), _ = lr(e, h, l), m = lr(s, h, l), N.push(Ia[c]), N.push(Na[c])) : c === 42 ? (I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l), N.push(Ma[c]), N.push(La[c])) : c === 128 && (I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Ma[c]), N.push(La[c])), c === 5 ? (w = 1 - lr(e, l, p), I = 1 - lr(e, h, f), N.push(Na[c])) : c === 165 ? (w = lr(s, p, l), I = lr(s, f, h), N.push(Na[c])) : c === 20 ? (x = lr(e, f, p), m = lr(e, h, l), N.push(Ca[c])) : c === 150 ? (x = 1 - lr(s, p, f), m = 1 - lr(s, l, h), N.push(Ca[c])) : c === 80 ? (E = lr(e, p, l), b = lr(e, f, h), N.push(Ia[c])) : c === 90 ? (E = 1 - lr(s, l, p), b = 1 - lr(s, h, f), N.push(Ia[c])) : c === 65 ? (v = 1 - lr(e, p, f), _ = 1 - lr(e, l, h), N.push(Sa[c])) : c === 105 ? (v = lr(s, f, p), _ = lr(s, h, l), N.push(Sa[c])) : c === 160 ? (E = lr(s, p, l), w = lr(e, p, l), I = lr(e, f, h), b = lr(s, f, h), N.push(Ia[c]), N.push(Na[c])) : c === 10 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), N.push(Ia[c]), N.push(Na[c])) : c === 130 ? (x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Ca[c]), N.push(Sa[c])) : c === 40 ? (x = lr(s, f, p), v = lr(e, f, p), _ = lr(e, h, l), m = lr(s, h, l), N.push(Ca[c]), N.push(Sa[c])) : c === 101 ? (w = lr(s, p, l), _ = lr(s, h, l), N.push(Na[c])) : c === 69 ? (w = 1 - lr(e, l, p), _ = 1 - lr(e, l, h), N.push(Na[c])) : c === 149 ? (I = lr(s, f, h), m = 1 - lr(s, l, h), N.push(Ma[c])) : c === 21 ? (I = 1 - lr(e, h, f), m = lr(e, h, l), N.push(Ma[c])) : c === 86 ? (x = 1 - lr(s, p, f), b = 1 - lr(s, h, f), N.push(Ca[c])) : c === 84 ? (x = lr(e, f, p), b = lr(e, f, h), N.push(Ca[c])) : c === 89 ? (E = 1 - lr(s, l, p), v = lr(s, f, p), N.push(Sa[c])) : c === 81 ? (E = lr(e, p, l), v = 1 - lr(e, p, f), N.push(Sa[c])) : c === 96 ? (E = lr(s, p, l), w = lr(e, p, l), b = lr(e, f, h), _ = lr(s, h, l), N.push(Ia[c]), N.push(Na[c])) : c === 74 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), b = 1 - lr(s, h, f), _ = 1 - lr(e, l, h), N.push(Ia[c]), N.push(Na[c])) : c === 24 ? (E = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), m = lr(e, h, l), N.push(Ia[c]), N.push(Sa[c])) : c === 146 ? (E = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), m = 1 - lr(s, l, h), N.push(Ia[c]), N.push(Sa[c])) : c === 6 ? (w = 1 - lr(e, l, p), x = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), N.push(Na[c]), N.push(Ca[c])) : c === 164 ? (w = lr(s, p, l), x = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), N.push(Na[c]), N.push(Ca[c])) : c === 129 ? (v = 1 - lr(e, p, f), I = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Sa[c]), N.push(Ma[c])) : c === 41 ? (v = lr(s, f, p), I = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l), N.push(Sa[c]), N.push(Ma[c])) : c === 66 ? (x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = 1 - lr(e, l, h), N.push(Ca[c]), N.push(Sa[c])) : c === 104 ? (x = lr(s, f, p), v = lr(e, f, p), b = lr(e, f, h), _ = lr(s, h, l), N.push(Sa[c]), N.push(Pa[c])) : c === 144 ? (E = lr(e, p, l), I = lr(e, f, h), b = lr(s, f, h), m = 1 - lr(s, l, h), N.push(Ia[c]), N.push(La[c])) : c === 26 ? (E = 1 - lr(s, l, p), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), m = lr(e, h, l), N.push(Ia[c]), N.push(La[c])) : c === 36 ? (w = lr(s, p, l), x = lr(e, f, p), _ = lr(e, h, l), m = lr(s, h, l), N.push(Na[c]), N.push(Ca[c])) : c === 134 ? (w = 1 - lr(e, l, p), x = 1 - lr(s, p, f), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Na[c]), N.push(Ca[c])) : c === 9 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), v = lr(s, f, p), I = 1 - lr(e, h, f), N.push(Ia[c]), N.push(Na[c])) : c === 161 ? (E = lr(s, p, l), w = lr(e, p, l), v = 1 - lr(e, p, f), I = lr(s, f, h), N.push(Ia[c]), N.push(Na[c])) : c === 37 ? (w = lr(s, p, l), I = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l), N.push(Na[c]), N.push(Ma[c])) : c === 133 ? (w = 1 - lr(e, l, p), I = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h), N.push(Na[c]), N.push(Ma[c])) : c === 148 ? (x = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), m = 1 - lr(s, l, h), N.push(Ca[c]), N.push(La[c])) : c === 22 ? (x = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), m = lr(e, h, l), N.push(Ca[c]), N.push(La[c])) : c === 82 ? (E = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), b = 1 - lr(s, h, f), N.push(Ia[c]), N.push(Sa[c])) : c === 88 ? (E = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), b = lr(e, f, h), N.push(Ia[c]), N.push(Sa[c])) : c === 73 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), v = lr(s, f, p), _ = 1 - lr(e, l, h), N.push(Ia[c]), N.push(Na[c])) : c === 97 ? (E = lr(s, p, l), w = lr(e, p, l), v = 1 - lr(e, p, f), _ = lr(s, h, l), N.push(Ia[c]), N.push(Na[c])) : c === 145 ? (E = lr(e, p, l), v = 1 - lr(e, p, f), I = lr(s, f, h), m = 1 - lr(s, l, h), N.push(Ia[c]), N.push(Ma[c])) : c === 25 ? (E = 1 - lr(s, l, p), v = lr(s, f, p), I = 1 - lr(e, h, f), m = lr(e, h, l), N.push(Ia[c]), N.push(Ma[c])) : c === 70 ? (w = 1 - lr(e, l, p), x = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = 1 - lr(e, l, h), N.push(Na[c]), N.push(Ca[c])) : c === 100 ? (w = lr(s, p, l), x = lr(e, f, p), b = lr(e, f, h), _ = lr(s, h, l), N.push(Na[c]), N.push(Ca[c])) : c === 34 ? (d === 0 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)) : (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)), N.push(Ia[c]), N.push(Na[c]), N.push(Ma[c]), N.push(La[c])) : c === 35 ? (d === 4 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)) : (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)), N.push(Ia[c]), N.push(Na[c]), N.push(Sa[c]), N.push(La[c])) : c === 136 ? (d === 0 ? (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)) : (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)), N.push(Ia[c]), N.push(Na[c]), N.push(Ma[c]), N.push(La[c])) : c === 153 ? (d === 0 ? (E = lr(e, p, l), v = 1 - lr(e, p, f), I = 1 - lr(e, h, f), m = lr(e, h, l)) : (E = 1 - lr(s, l, p), v = lr(s, f, p), I = lr(s, f, h), m = 1 - lr(s, l, h)), N.push(Ia[c]), N.push(Sa[c])) : c === 102 ? (d === 0 ? (w = 1 - lr(e, l, p), x = lr(e, f, p), b = lr(e, f, h), _ = 1 - lr(e, l, h)) : (w = lr(s, p, l), x = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = lr(s, h, l)), N.push(Na[c]), N.push(La[c])) : c === 155 ? (d === 4 ? (E = lr(e, p, l), v = 1 - lr(e, p, f), I = 1 - lr(e, h, f), m = lr(e, h, l)) : (E = 1 - lr(s, l, p), v = lr(s, f, p), I = lr(s, f, h), m = 1 - lr(s, l, h)), N.push(Ia[c]), N.push(Ma[c])) : c === 103 ? (d === 4 ? (w = 1 - lr(e, l, p), x = lr(e, f, p), b = lr(e, f, h), _ = 1 - lr(e, l, h)) : (w = lr(s, p, l), x = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = lr(s, h, l)), N.push(Na[c]), N.push(Ca[c])) : c === 152 ? (d === 0 ? (E = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), m = lr(e, h, l)) : (E = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), m = 1 - lr(s, l, h)), N.push(Ia[c]), N.push(Ca[c]), N.push(Sa[c])) : c === 156 ? (d === 4 ? (E = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), m = lr(e, h, l)) : (E = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), m = 1 - lr(s, l, h)), N.push(Ia[c]), N.push(Sa[c]), N.push(La[c])) : c === 137 ? (d === 0 ? (E = lr(s, p, l), w = lr(e, p, l), v = 1 - lr(e, p, f), I = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)) : (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), v = lr(s, f, p), I = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)), N.push(Ia[c]), N.push(Na[c]), N.push(Sa[c])) : c === 139 ? (d === 4 ? (E = lr(s, p, l), w = lr(e, p, l), v = 1 - lr(e, p, f), I = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)) : (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), v = lr(s, f, p), I = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)), N.push(Ia[c]), N.push(Na[c]), N.push(Ma[c])) : c === 98 ? (d === 0 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), b = lr(e, f, h), _ = 1 - lr(e, l, h)) : (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = lr(s, h, l)), N.push(Ia[c]), N.push(Na[c]), N.push(La[c])) : c === 99 ? (d === 4 ? (E = 1 - lr(e, l, p), w = 1 - lr(s, l, p), x = lr(s, f, p), v = lr(e, f, p), b = lr(e, f, h), _ = 1 - lr(e, l, h)) : (E = lr(s, p, l), w = lr(e, p, l), x = 1 - lr(e, p, f), v = 1 - lr(s, p, f), b = 1 - lr(s, h, f), _ = lr(s, h, l)), N.push(Ia[c]), N.push(Na[c]), N.push(Sa[c])) : c === 38 ? (d === 0 ? (w = 1 - lr(e, l, p), x = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)) : (w = lr(s, p, l), x = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)), N.push(Na[c]), N.push(Ma[c]), N.push(La[c])) : c === 39 ? (d === 4 ? (w = 1 - lr(e, l, p), x = lr(e, f, p), I = lr(e, f, h), b = lr(s, f, h), _ = 1 - lr(s, l, h), m = 1 - lr(e, l, h)) : (w = lr(s, p, l), x = 1 - lr(s, p, f), I = 1 - lr(s, h, f), b = 1 - lr(e, h, f), _ = lr(e, h, l), m = lr(s, h, l)), N.push(Na[c]), N.push(Ca[c]), N.push(La[c])) : c === 85 && (E = 1, w = 0, x = 1, v = 0, I = 0, b = 1, _ = 0, m = 1), (_ < 0 || _ > 1 || m < 0 || m > 1 || E < 0 || E > 1 || x < 0 || x > 1 || I < 0 || I > 1 || b < 0 || b > 1) && console.log('MarchingSquaresJS-isoBands: ' + c + ' ' + g + ' ' + h + ',' + l + ',' + p + ',' + f + ' ' + d + ' ' + _ + ' ' + m + ' ' + E + ' ' + w + ' ' + x + ' ' + v + ' ' + I + ' ' + b), o.cells[a][u] = {
                                cval: c,
                                cval_real: g,
                                flipped: d,
                                topleft: _,
        ...
        return zs.polygons ? (zs.verbose && console.log('MarchingSquaresJS-isoBands: returning single polygons for each grid cell'), u = (function (t) {
            ...
            return t.cells.forEach(function (t, r) {
                t.forEach(function (t, i) {
                    if (void 0 !== t) {
                        var o = Ra[t.cval](t);
                        typeof o === 'object' && pr(o) ? typeof o[0] === 'object' && pr(o[0]) ? typeof o[0][0] === 'object' && pr(o[0][0]) ? o.forEach(function (t) {
                            t.forEach(function (t) {
                                t[0] += i, t[1] += r;
                            }), e[n++] = t;
                ...
                for (var s = 0; s < r; s++) {
                    if (void 0 !== t.cells[o][s] && t.cells[o][s].edges.length > 0) {
                        var a = t.cells[o][s],
                            ...
                            h = s,
                            l = o;
                        u !== null && i.push([u.p[0] + h, u.p[1] + l]);
                        do {
                            if ((c = (function (t, e, n, r) {
                            ...
                            }(t.cells[l][h], u.x, u.y, u.o))) === null) break;
                                ...
                                var p = (function (t, e, n, r, i, o) {
                                    ...
                                    for (; !l;) {
                                        if (void 0 === t.cells[c] || void 0 === t.cells[c][u]) {
                                            if (c -= i, u -= r, s = t.cells[c][u], a = s.cval_real, i === -1) {
                                                if (o === 0) {
                                        ...
                                        else if (s = t.cells[c][u], a = s.cval_real, r === -1) {
                                            if (o === 0) {
                                            ...
                                            if (void 0 !== t.cells[c + 1] && void 0 !== t.cells[c + 1][u]) r = 0, i = 1, o = 0;
                                            else {
                                                if (!(a & Xs)) {
                                                    h.push([u + s.topleft, c + 1]), r = 0, i = -1, o = 0, l = !0;
                                                    break;
            ...
            return e;
        }(c))), typeof zs.successCallback === 'function' && zs.successCallback(u), u;
    }
    ...
    function fr (t, e, n) {
        ...
        var r = n.pivot,
            i = n.mutate;
        if (!t) throw new Error('geojson is required');
        if (void 0 === e || e === null || isNaN(e)) throw new Error('angle is required');
        return e === 0 ? t : (r || (r = ye(t)), !1 !== i && void 0 !== i || (t = Gt(t)), S(t, function (t) {
            var n = sn(r, t) + e,
                i = un(r, t),
                o = U(nr(r, i, n));
            t[0] = o[0], t[1] = o[1];
    ...
    function gr (t, e, n) {
        ...
        if (typeof e !== 'number' || e === 0) throw new Error('invalid factor');
        var o = Array.isArray(r) || typeof r === 'object';
        return !0 !== i && (t = Gt(t)), t.type !== 'FeatureCollection' || o ? dr(t, e, r) : (O(t, function (n, i) {
    ...
    function dr (t, e, n) {
        ...
        return n = (function (t, e) {
            void 0 !== e && e !== null || (e = 'centroid');
            if (Array.isArray(e) || typeof e === 'object') return X(e);
        ...
        }(t, n)), e === 1 || i ? t : (S(t, function (t) {
            var r = un(n, t),
                i = sn(n, t),
                o = U(nr(n, r * e, i));
            t[0] = o[0], t[1] = o[1], t.length === 3 && (t[2] *= e);
        }), t);
    }
    ...
    function vr (t, e, n) {
        ...
        return o.forEach(function (t, e) {
            if (e !== o.length - 1) {
                ...
                o.length === 2 && (s.push(n[0]), s.push(n[1]));
            }
        }), a(s, t.properties);
    }
    ...
    function Cr (t, e) {
        for (var n = !1, r = !1, i = t.coordinates.length, o = 0; o < i && !n && !r;) {
            for (var s = 0; s < e.coordinates.length - 1; s++) {
                var a = !0;
                s !== 0 && s !== e.coordinates.length - 2 || (a = !1), Lr(e.coordinates[s], e.coordinates[s + 1], t.coordinates[o], a) ? n = !0 : r = !0;
            }
            o++;
        }
        return n && r;
    ...
    function Tr (t, e) {
        ...
        if (n === 'Point') throw new Error('Point geometry not supported');
        if (new ja({
            precision: 6
    ...
    function hi (t, e) {
        ...
        if ((function () {
            ...
            (function (t, e, n, r) {
                var i, o, s, a, u, c, h, l, p, f, g, d, y = su.length,
                    _ = !0;
                for (i = 0; i < y; ++i) {
                    if (o = su[i]) {
    ...
    function pi (t, e, n, r) {
        ...
        for (var p = [], f = 0; f < i; f += 1) {
            ...
            if (g < -90 && g >= -270 && (d = -d), g < -180 && g >= -360 && (y = -y), s === 'degrees') {
        ...
        return p.push(p[0]), s === 'degrees' ? o([p], c) : fr(o([p], c), a, {
            pivot: u
        });
    }
    ...
    function gi (t, e) {
        ...
        return A(t, function (t, e, n) {
            var r = n[i];
            if (r = void 0 === r || r === null ? 1 : r, !b(r)) throw new Error('weight value must be a number for feature index ' + e);
    ...
    function di (t, e, n, i) {
        ...
        var h = s / u,
            l = a / u;
        return c === 1 || i === 0 || Math.abs(h - e[0]) < o && Math.abs(l - e[1]) < o ? r([h, l], {
    ...
    function vi (t, e) {
        ...
        void 0 !== t && t !== null || (t = 1), b(r) || (r = 10), b(i) || (i = 10);
        for (var s = [], a = 0; a < t; a++) {
            var u = [],
    ...
    function xi (t, e) {
        ...
        var n = e.bbox,
            ...
            i = e.max_length,
            o = e.max_rotation;
        void 0 !== t && t !== null || (t = 1), (!b(r) || r < 2) && (r = 10), b(i) || (i = 1e-4), b(o) || (o = Math.PI / 8);
        for (var s = [], u = 0; u < t; u++) {
            for (var h = [_i(n)], l = 0; l < r - 1; l++) {
                var p = (l === 0 ? 2 * Math.random() * Math.PI : Math.tan((h[l][1] - h[l - 1][1]) / (h[l][0] - h[l - 1][0]))) + (Math.random() - 0.5) * o * 2,
                    f = Math.random() * i;
    ...
    function wi (t, e) {
        if (!t) throw new Error('geojson is required');
        if (t.type !== 'FeatureCollection') throw new Error('geojson must be a FeatureCollection');
        if (void 0 === e || e === null) throw new Error('filter is required');
        var n = [];
    ...
    function bi (t, e, n) {
        if (!t) throw new Error('geojson is required');
        if (t.type !== 'FeatureCollection') throw new Error('geojson must be a FeatureCollection');
        if (void 0 === e || e === null) throw new Error('property is required');
    ...
    function Ci (t, e) {
        ...
        var n = typeof e;
        if (n === 'number' || n === 'string') return t.hasOwnProperty(e);
        if (Array.isArray(e)) {
            for (var r = 0; r < e.length; r++) {
                if (!Ci(t, e[r])) return !1;
            }
            return !0;
        }
        return Si(t, e);
    ...
    function fo (t, e, n, r) {
        ...
        function o (i, o, a, c) {
            var h = 0,
                l = 0;
            if (i == null || (h = s(i, a)) !== (l = s(o, a)) || u(i, o) < 0 ^ a > 0) {
                do {
                    c.point(h === 0 || h === 3 ? t : n, h > 1 ? r : e);
                } while ((h = (h + a + 4) % 4) !== l);
            }
        ...
        function u (t, e) {
            var n = s(t, 1),
                r = s(e, 1);
            return n !== r ? n - r : n === 0 ? e[1] - t[1] : n === 1 ? t[0] - e[0] : n === 2 ? t[1] - e[1] : e[0] - t[0];
        }
        return function (s) {
            function u (t, e) {
                i(t, e) && E.point(t, e);
    ...
    function vo (t, e, n) {
        ...
        t.scale(150).translate([0, 0]), o != null && t.clipExtent(null), ng(n, t.stream(vg));
        var s = vg.result(),
            a = Math.min(r / (s[1][0] - s[0][0]), i / (s[1][1] - s[0][1])),
            u = +e[0][0] + (r - a * (s[1][0] + s[0][0])) / 2,
            c = +e[0][1] + (i - a * (s[1][1] + s[0][1])) / 2;
        return o != null && t.clipExtent(o), t.scale(150 * a).translate([u, c]);
    }
    ...
    function xo (t) {
        return (function (t) {
            ...
            e.stream = function (t) {
                ...
                return arguments.length ? (C = t == null ? (N = h = l = p = null, gg) : fo(N = +t[0][0], h = +t[0][1], l = +t[1][0], p = +t[1][1]), i()) : N == null ? null : [
                    [N, h],
                    [l, p]
                ];
            }, e.scale = function (t) {
    ...
    function No (t, e) {
        return typeof t[0] !== 'object' ? e(t) : t.map(function (t) {
            return No(t, e);
        });
    }

    function Co (t, e) {
        return typeof t[0] !== 'object' ? e.invert(t) : t.map(function (t) {
            return Co(t, e);
        });
    }
    ...
    function Oo (t, e, n) {
        ...
        if (!Array.isArray(t)) throw new Error('bbox must be array');
        if (t.length !== 4) throw new Error('bbox must contain 4 numbers');
        if (s && ['Polygon', 'MultiPolygon'].indexOf(K(s)) === -1) throw new Error('options.mask must be a (Multi)Polygon');
        var a = t[0],
            u = t[1],
            h = t[2],
            l = t[3],
    ...
    function Do (t, e, n) {
        ...
        for (var a = e / qt([t[0], t[1]], [t[2], t[1]], n) * (t[2] - t[0]), u = e / qt([t[0], t[1]], [t[0], t[3]], n) * (t[3] - t[1]), h = 0, l = t[0]; l <= t[2];) {
            for (var p = 0, f = t[1]; f <= t[3];) {
                ...
                ], r)), i ? (Lo(i, g) && s.push(g), Lo(i, d) && s.push(d)) : (s.push(g), s.push(d)), f += u, p++;
            }
            h++, l += a;
        }
        return c(s);
    ...
    st.prototype = {
        ...
        remove: function (t, e) {
            ...
            for (var n, r, i, o, s = this.data, a = this.toBBox(t), u = [], c = []; s || u.length;) {
                if (s || (s = u.pop(), r = u[u.length - 1], n = c.pop(), o = !0), s.leaf && (i = (function (t, e, n) {
                    if (!n) return e.indexOf(t);
                    for (var r = 0; r < e.length; r++) {
                        if (n(t, e[r])) return r;
                    }
                    return -1;
                }(t, s.children, e))) !== -1) return s.children.splice(i, 1), u.push(s), this._condense(u), this;
        ...
        _build: function (t, e, n, r) {
            ...
            for (_t(t, e, n, p, this.compareMinX), a = e; a <= n; a += p) {
                for (_t(t, a, c = Math.min(a + p - 1, n), l, this.compareMinY), u = a; u <= c; u += l) h = Math.min(u + l - 1, c), i.children.push(this._build(t, u, h, r - 1));
            }
        ...
        _chooseSubtree: function (t, e, n, r) {
            for (var i, o, s, a, u, c, h, l; r.push(e), !e.leaf && r.length - 1 !== n;) {
                for (h = l = 1 / 0, i = 0, o = e.children.length; i < o; i++) {
                    u = pt(s = e.children[i]), (c = (function (t, e) {
        ...
        _condense: function (t) {
            for (var e, n = t.length - 1; n >= 0; n--) t[n].children.length === 0 ? n > 0 ? (e = t[n - 1].children).splice(e.indexOf(t[n]), 1) : this.clear() : at(t[n], this.toBBox);
        },
    ...
    var Ho = function (t, e, n) {
        ...
        Ko = function (t, e) {
            ...
            return o[1] && (i[a++] = o[1]), a === 0 && (i[a++] = 0), i.length = a, i;
        },
        Qo = function (t, e) {
            var n = 0 | t.length,
                r = 0 | e.length;
        ...
        $o = mt(function (t) {
            ...
            function r (t) {
                ...
                if (t.length === 2) return ['sum(', t[0], ',', t[1], ')'].join('');
                var e = t.length >> 1;
            ...
            function o (t) {
                for (var n = [], o = [], s = (function (t) {
                        ...
                        return e;
                    }(t)), a = [], u = 0; u < t; ++u) (1 & u) == 0 ? n.push.apply(n, i(e(s, u))) : o.push.apply(o, i(e(s, u))), a.push('m' + u);
                var c = r(n),
                    h = r(o),
        ...
        ts = function (t) {
            ...
            if (e < 3) {
                ...
                return e === 2 && t[0][0] === t[1][0] && t[0][1] === t[1][1] ? [0] : n;
            }
            var i = new Array(e);
            for (r = 0; r < e; ++r) i[r] = r;
            i.sort(function (e, n) {
    ...
    var us = function (t) {
        ...
        fs = function (t, e, n, r, i, o) {
            arguments.length === 3 && (r = o = Array, i = null);
        ...
        ws = function (t, e) {
            ...
            var o = (function (t) {
                    function e (t) {
                        t != null && c.hasOwnProperty(t.type) && c[t.type](t);
                    }
                ...
                s = e > 0 && o && (function (t, e, n) {
                    ...
                    function u (t) {
                        t != null && d.hasOwnProperty(t.type) && d[t.type](t);
                    }
                    var c = e[0],
                        h = e[1],
                        l = e[2],
    ...
    ve.deviation = function (t, e, n, r) {
        ...
        _build: function (t, e, n, r) {
            ...
            for (Ke(t, e, n, p, this.compareMinX), a = e; a <= n; a += p) {
                for (Ke(t, a, c = Math.min(a + p - 1, n), l, this.compareMinY), u = a; u <= c; u += l) h = Math.min(u + l - 1, c), i.children.push(this._build(t, u, h, r - 1));
            }
        ...
        _chooseSubtree: function (t, e, n, r) {
            for (var i, o, s, a, u, c, h, l; r.push(e), !e.leaf && r.length - 1 !== n;) {
                for (h = l = 1 / 0, i = 0, o = e.children.length; i < o; i++) {
                    u = Ve(s = e.children[i]), (c = (function (t, e) {
                        return (Math.max(e.maxX, t.maxX) - Math.min(e.minX, t.minX)) * (Math.max(e.maxY, t.maxY) - Math.min(e.minY, t.minY));
                    }(t, s)) - u) < l ? (l = c, h = u < h ? u : h, a = s) : c === l && u < h && (h = u, a = s);
                }
                e = a || e.children[0];
        ...
        _condense: function (t) {
            for (var e, n = t.length - 1; n >= 0; n--) t[n].children.length === 0 ? n > 0 ? (e = t[n - 1].children).splice(e.indexOf(t[n]), 1) : this.clear() : ze(t[n], this.toBBox);
        },
        _initFormat: function (t) {
            var e = ['return a', ' - b', ';'];
            this.compareMinX = new Function('a', 'b', e.join(t[0])), this.compareMinY = new Function('a', 'b', e.join(t[1])), this.toBBox = new Function('a', 'return {minX: a' + t[0] + ', minY: a' + t[1] + ', maxX: a' + t[2] + ', maxY: a' + t[3] + '};');
    ...
    var Cs = Object.freeze({
        ...
        Ms = function (t, e, n) {
                ...
                var u = o[t][n],
                    ...
                    p = (function (t, e, n, r) {
                        ...
                        var i = t[0],
                            ...
                            l = r[1],
                            p = (i - s) * (c - l) - (o - a) * (u - h);
                        return p === 0 ? null : [((i * a - o * s) * (u - h) - (i - s) * (u * l - c * h)) / p, ((i * a - o * s) * (c - l) - (o - a) * (u * l - c * h)) / p];
                    }(u, c, h, l));
                if (p !== null) {
                    var f, g;
            ...
            if (t.geometry.type !== 'Polygon') throw new Error('The input feature must be a Polygon');
            void 0 === n && (n = 1);
        ...
        Ls = function (t) {
            function e () {
                for (var t = [], e = 0; e < g.features.length; e++) g.features[e].properties.parent == -1 && t.push(e);
                if (t.length > 1) {
                    for (e = 0; e < t.length; e++) {
                        for (var n = -1, r = 0; r < g.features.length; r++) {
                            t[e] != r && Pt(g.features[t[e]].geometry.coordinates[0][0], g.features[r], {
                                ignoreBoundary: !0
            ...
            function n () {
                for (var t = 0; t < g.features.length; t++) {
                    if (g.features[t].properties.parent == -1) {
            ...
            if (t.type != 'Feature') throw new Error('The input must a geojson object of type Feature');
            if (void 0 === t.geometry || t.geometry == null) throw new Error('The input must a geojson object with a non-empty geometry');
            if (t.geometry.type != 'Polygon') throw new Error('The input must be a geojson Polygon');
                ...
                for (a = 0; a < i; a++) {
                    f.push(o([t.geometry.coordinates[a]], {
                        ...
                        winding: (function (t) {
                            ...
                            if (Rn([t[(e - 1).modulo(t.length - 1)], t[e], t[(e + 1).modulo(t.length - 1)]], !0)) var r = 1;
                            else r = -1;
                            return r;
                ...
                for (; !Tn(y[O].coord, y[G].coord);) {
                    ...
                    if (void 0 != B && N.splice(B, 1), Tn(q, y[G].ringAndEdge1)) {
                        if (q = y[G].ringAndEdge2, y[G].ringAndEdge2Walkable = !1, y[G].ringAndEdge1Walkable) {
                            ...
                            Rn([y[F].coord, y[G].coord, y[y[G].nxtIsectAlongRingAndEdge2].coord], T == 1) ? (k.parent = R, k.winding = -T) : (k.parent = A, k.winding = T), N.push(k);
                        }
                        ...
                        if (q = y[G].ringAndEdge1, y[G].ringAndEdge1Walkable = !1, y[G].ringAndEdge2Walkable) {
                            ...
                            Rn([y[F].coord, y[G].coord, y[y[G].nxtIsectAlongRingAndEdge1].coord], T == 1) ? (k.parent = R, k.winding = -T) : (k.parent = A, k.winding = T), N.push(k);
                        }
    ...
    Fs.prototype.json = function () {
        ...
        for (var t = '', e = 'LINESTRING(', n = function (t) {
            ...
            if (this.geometries[r].coords.length === 0) return 'LINESTRING(empty)';
            ...
            for (var v = 0; v < n.length; ++v) {
                ...
                if (v > 0 && Math.abs(x - n[v - 1][0]) > p) {
                    var E = parseFloat(n[v - 1][0]),
                        ...
                        b = parseFloat(n[v][0]),
                        I = parseFloat(n[v][1]);
                    if (E > -180 && E < l && b === 180 && v + 1 < n.length && n[v - 1][0] > -180 && n[v - 1][0] < l) {
                        m.push([-180, n[v][1]]), v++, m.push([n[v][0], n[v][1]]);
                        continue;
                    }
                    if (E > h && E < 180 && b === -180 && v + 1 < n.length && n[v - 1][0] > h && n[v - 1][0] < 180) {
                        m.push([180, n[v][1]]), v++, m.push([n[v][0], n[v][1]]);
                        continue;
                    }
                    if (E < l && b > h) {
    ...
    Da.prototype.push = function (t) {
        ...
        var t = this,
            ...
            n = (e === 0 ? this.length : e) - 1,
            r = (e + 1) % this.length,
            i = xr(this.edges[n].from.coordinates, this.edges[e].from.coordinates, this.edges[r].from.coordinates);
        return i === 0 ? this.edges[n].from.coordinates[0] > this.edges[r].from.coordinates[0] : i > 0;
    ...
    qa.fromGeoJson = function (t) {
        !(function (t) {
            ...
            if (t.type !== 'FeatureCollection' && t.type !== 'GeometryCollection' && t.type !== 'MultiLineString' && t.type !== 'LineString' && t.type !== 'Feature') throw new Error('Invalid input type \'' + t.type + '\'. Geojson must be FeatureCollection, GeometryCollection, LineString, MultiLineString or Feature');
        }(t));
        var e = new qa();
        return F(t, function (t) {
        ...
        void 0 === t ? Object.keys(this.nodes).forEach(function (t) {
            ...
            t.getOuterEdge((n === 0 ? t.getOuterEdges().length : n) - 1).symetric.next = e;
        });
    ...
    var Ga = mt(function (t, e) {
        ...
        Ba = (Ga.shim, mt(function (t, e) {
            ...
            function r (t) {
                return t && typeof t === 'object' && typeof t.length === 'number' && Object.prototype.hasOwnProperty.call(t, 'callee') && !Object.prototype.propertyIsEnumerable.call(t, 'callee') || !1;
            }
            var i = (function () {
        ...
        ka = (Ba.supported, Ba.unsupported, mt(function (t) {
            ...
            var r = Array.prototype.slice,
                i = t.exports = function (t, o, s) {
                    return s || (s = {}), t === o || (t instanceof Date && o instanceof Date ? t.getTime() === o.getTime() : !t || !o || typeof t !== 'object' && typeof o !== 'object' ? s.strict ? t === o : t == o : (function (t, o, s) {
                        var a, u;
                        if (e(t) || e(o)) return !1;
    ...
    var ja = za,
        ...
        Ya = mt(function (t) {
            ...
            e.prototype.insert = function (t, e) {
                for (var n = this._queue.length, r = n; r--;) {
                    ...
                    this._sorting === 'desc' ? e > i && (n = r) : e < i && (n = r);
                }
        ...
        eu = function (t, e, n, r) {
            var i = [],
                ...
                p = l > 0,
                f = [];
            if (n) i = n == 'kmrand' ? Qa(t, e) : n == 'kmpp' ? $a(t, e) : n;
            else {
        ...
        bubbleUp: function (t) {
            for (var e = this.content.length, n = this.content[t], r = this.scoreFunction(n); ;) {
                ...
                if (o < e) {
                    ...
                    this.scoreFunction(c) < (a === null ? r : i) && (a = o);
                }
                if (a === null) break;
    ...
    jr.prototype = {
        ...
        remove: function (t) {
            ...
            var e, n, r, i = t.U,
                o = t.L,
                s = t.R;
            if (n = o ? s ? Vr(s) : o : s, i ? i.L === t ? i.L = n : i.R = n : this._ = n, o && s ? (r = n.C, n.C = t.C, n.L = o, o.U = n, n !== s ? (i = n.U, n.U = t.U, t = n.R, i.L = t, n.R = s, s.U = n) : (n.U = i, i = n, t = n.R)) : (r = t.C, t = n), t && (t.U = i), !r) {
                if (t && t.C) t.C = !1;
                else {
                    do {
                        if (t === this._) break;
    ...
    hi.prototype = {
        ...
        triangles: function () {
            ...
            return this.cells.forEach(function (n, r) {
                if (o = (i = n.halfedges).length) {
                    for (var i, o, s, a = n.site, u = -1, c = e[i[o - 1]], h = c.left === a ? c.right : c.left; ++u < o;) s = h, h = (c = e[i[u]]).left === a ? c.right : c.left, s && h && r < s.index && r < h.index && ui(a, s, h) < 0 && t.push([a.data, s.data, h.data]);
                }
            }), t;
        },
        links: function () {
        ...
        find: function (t, e, n) {
            ...
            return o._found = r, n == null || h <= n * n ? i.site : null;
        }
    };
    var fu = function () {
            function t (t) {
            ...
            return t.polygons = function (e) {
                ...
                return arguments.length ? (e = typeof n === 'function' ? n : ru(+n), t) : e;
            }, t.y = function (e) {
                return arguments.length ? (n = typeof e === 'function' ? e : ru(+e), t) : n;
            }, t.extent = function (e) {
                return arguments.length ? (r = e == null ? null : [
                    [+e[0][0], +e[0][1]],
                    [+e[1][0], +e[1][1]]
                ], t) : r && [
                    [r[0][0], r[0][1]],
    ...
    'fill' in Array.prototype || Object.defineProperty(Array.prototype, 'fill', {
        configurable: !0,
        value: function (t) {
            if (void 0 === this || this === null) throw new TypeError(this + ' is not an object');
            var e = Object(this),
    ...
    var xu = function () {},
        ...
        wu = function () {},
        bu = function t () {
            if (this.x = null, this.y = null, this.z = null, arguments.length === 0) this.x = 0, this.y = 0, this.z = t.NULL_ORDINATE;
            else if (arguments.length === 1) {
                var e = arguments[0];
                this.x = e.x, this.y = e.y, this.z = e.z;
            }
            else arguments.length === 2 ? (this.x = arguments[0], this.y = arguments[1], this.z = t.NULL_ORDINATE) : arguments.length === 3 && (this.x = arguments[0], this.y = arguments[1], this.z = arguments[2]);
        },
        Iu = {
    ...
    var Nu = function (t) {
        if (this._dimensionsToTest = 2, arguments.length === 0);
            ...
            var e = arguments[0];
            if (e !== 2 && e !== 3) throw new _u('only 2 or 3 dimensions may be specified');
    ...
    Du.prototype.le = function (t) {
        ...
        if (n.charAt(0) === '0') throw new Error('Found leading zero: ' + n);
        var i = '';
    ...
    Wu.prototype.read = function (t) {
        ...
        if (t.search('EMPTY') !== -1 && ((i = Hu.emptyTypeStr.exec(t))[2] = void 0), i && (n = i[1].toLowerCase(), r = i[2], Zu[n] && (e = Zu[n].apply(this, [r]))), void 0 === e) throw new Error('Could not parse WKT ' + t);
        return e;
    ...
    var Ju = {
        ...
        Zu = {
            ...
            polygon: function (t) {
                ...
                for (var e, n, r, i, o = t.trim().split(Hu.parenComma), s = [], a = 0, u = o.length; a < u; ++a) e = o[a].replace(Hu.trimParens, '$1'), n = Zu.linestring.apply(this, [e]), r = this.geometryFactory.createLinearRing(n._points), a === 0 ? i = r : s.push(r);
    ...
    var Qu = (function (t) {
        ...
        $u = (function (t) {
            function e () {
                if (t.call(this), arguments.length === 0) t.call(this);
                else if (arguments.length === 1) {
                    var e = arguments[0];
                    t.call(this, e);
                }
    ...
    tc.prototype.interfaces_ = function () {
        ...
        if (arguments.length === 0) tc.shouldNeverReachHere(null);
        else if (arguments.length === 1) {
            var t = arguments[0];
            throw new $u('Should never reach here' + (t !== null ? ': ' + t : ''));
        }
    }, tc.isTrue = function () {
        var t, e;
        if (arguments.length === 1) t = arguments[0], tc.isTrue(t, null);
        else if (arguments.length === 2 && (t = arguments[0], e = arguments[1], !t)) throw e === null ? new $u() : new $u(e);
    }, tc.equals = function () {
        var t, e, n;
        if (arguments.length === 2) t = arguments[0], e = arguments[1], tc.equals(t, e, null);
        else if (arguments.length === 3 && (t = arguments[0], e = arguments[1], n = arguments[2], !e.equals(t))) throw new $u('Expected ' + t + ' but encountered ' + e + (n !== null ? ': ' + n : ''));
    };
    var ec = function () {
    ...
    ec.prototype.getIndexAlongSegment = function (t, e) {
        ...
        if (t.equals(e)) o = 0;
            ...
            var s = Math.abs(t.x - e.x),
                a = Math.abs(t.y - e.y);
            (o = r > i ? s : a) !== 0 || t.equals(e) || (o = Math.max(s, a));
        }
        return tc.isTrue(!(o === 0 && !t.equals(e)), 'Bad distance calculation'), o;
    }, ec.nonRobustComputeEdgeDistance = function (t, e, n) {
        var r = t.x - e.x,
            i = t.y - e.y,
            o = Math.sqrt(r * r + i * i);
        return tc.isTrue(!(o === 0 && !t.equals(e)), 'Invalid distance calculation'), o;
    ...
    var rc = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.isInSegmentEnvelopes = function (t) {
                ...
                if (arguments.length !== 3) return t.prototype.computeIntersection.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1],
                    r = arguments[2];
                if (this._isProper = !1, Yu.intersects(n, r, e) && sc.orientationIndex(n, r, e) === 0 && sc.orientationIndex(r, n, e) === 0) return this._isProper = !0, (e.equals(n) || e.equals(r)) && (this._isProper = !1), this._result = t.POINT_INTERSECTION, null;
                ...
                return this.isInSegmentEnvelopes(o) || (o = new bu(e.nearestEndpoint(t, n, r, i))), this._precisionModel !== null && this._precisionModel.makePrecise(o), o;
                ...
                return o === 0 && s === 0 && a === 0 && u === 0 ? this.computeCollinearIntersection(e, n, r, i) : (o === 0 || s === 0 || a === 0 || u === 0 ? (this._isProper = !1, e.equals2D(r) || e.equals2D(i) ? this._intPt[0] = e : n.equals2D(r) || n.equals2D(i) ? this._intPt[0] = n : o === 0 ? this._intPt[0] = new bu(r) : s === 0 ? this._intPt[0] = new bu(i) : a === 0 ? this._intPt[0] = new bu(e) : u === 0 && (this._intPt[0] = new bu(n))) : (this._isProper = !0, this._intPt[0] = this.intersection(e, n, r, i)), t.POINT_INTERSECTION);
    ...
    ic.prototype.interfaces_ = function () {
        ...
        var i = null,
            o = null,
            s = null;
        if (i = 1, t === 0 || r === 0) return e === 0 || n === 0 ? 0 : e > 0 ? n > 0 ? -i : i : n > 0 ? i : -i;
        if (e === 0 || n === 0) return r > 0 ? t > 0 ? i : -i : t > 0 ? -i : i;
    ...
    oc.prototype.countSegment = function (t, e) {
        ...
        if (t.y > this._p.y && e.y <= this._p.y || e.y > this._p.y && t.y <= this._p.y) {
            ...
            if (u === 0) return this._isPointOnSegment = !0, null;
        ...
        if (arguments[0] instanceof bu && Lu(arguments[1], Bu)) {
            for (var t = arguments[0], e = arguments[1], n = new oc(t), r = new bu(), i = new bu(), o = 1; o < e.size(); o++) {
    ...
    sc.prototype.interfaces_ = function () {
        ...
        if (arguments.length === 2) {
            var t = arguments[0],
                e = arguments[1];
            if (e.length === 0) throw new _u('Line array must contain at least one vertex');
    ...
    cc.prototype.isGeometryCollection = function () {
        ...
        if (arguments[0] instanceof cc) {
            var t = arguments[0];
            return t !== null && this.equalsTopo(t);
        }
        ...
        return this._envelope === null && (this._envelope = this.computeEnvelopeInternal()), new Yu(this._envelope);
    ...
    var bc = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.ensureCapacity = function () {}, e.prototype.interfaces_ = function () {
                ...
                return arguments.length === 1 ? this.array_.push(t) : this.array_.splice(arguments[0], arguments[1]), !0;
        ...
        Nc = (function (t) {
            function e () {
                if (t.call(this), arguments.length === 0);
                else if (arguments.length === 1) {
                    var e = arguments[0];
            ...
            return n.coordArrayType.get = function () {
                ...
                if (arguments.length === 1) {
                    ...
                    if (arguments[0] instanceof bu && typeof arguments[1] === 'boolean') {
                        var i = arguments[0];
                    ...
                    if (typeof arguments[2] === 'boolean' && Number.isInteger(arguments[0]) && arguments[1] instanceof bu) {
                        var l = arguments[0],
                            p = arguments[1];
                        if (!arguments[2]) {
                            var f = this.size();
    ...
    Sc.ForwardComparator.get = function () {
        ...
        if (arguments.length === 3) {
            ...
            for (var s = 0; s < r.length; s++) {
                if (o.compare(r[s], i[s]) !== 0) return !1;
            }
            return !0;
        }
        ...
        if (e === 0) return r;
        for (var i = 0, o = 0; o < t.length; o++) t[o] !== null && (r[i++] = t[o]);
        return r;
        ...
        if (arguments.length === 5) {
            for (var r = arguments[0], i = arguments[1], o = arguments[2], s = arguments[3], a = arguments[4], u = 0; u < a; u++) o[s + u] = new bu(r[i + u]);
        }
    }, Cc.isEqualReversed = function (t, e) {
        for (var n = 0; n < t.length; n++) {
            var r = t[n],
                i = e[t.length - n - 1];
            if (r.compareTo(i) !== 0) return !1;
        }
        return !0;
    ...
    (Gi.prototype = new Oc()).get = function (t) {
        ...
        for (t.color = 1; t != null && t !== this.root_ && t.parent.color === 1;) {
            if (Ai(t) === Fi(Ai(Ai(t)))) {
                var e = qi(Ai(Ai(t)));
                Ti(e) === 1 ? (Di(Ai(t), Ac), Di(e, Ac), Di(Ai(Ai(t)), 1), t = Ai(Ai(t))) : (t === qi(Ai(t)) && (t = Ai(t), this.rotateLeft(t)), Di(Ai(t), Ac), Di(Ai(Ai(t)), 1), this.rotateRight(Ai(Ai(t))));
            }
            else {
                var n = Fi(Ai(Ai(t)));
                Ti(n) === 1 ? (Di(Ai(t), Ac), Di(n, Ac), Di(Ai(Ai(t)), 1), t = Ai(Ai(t))) : (t === Fi(Ai(t)) && (t = Ai(t), this.rotateRight(t)), Di(Ai(t), Ac), Di(Ai(Ai(t)), 1), this.rotateLeft(Ai(Ai(t))));
            }
        }
        this.root_.color = Ac;
        ...
        if (e !== null) {
            for (t.add(e.value); (e = Gi.successor(e)) !== null;) t.add(e.value);
        }
        return t;
        ...
        var t = new Rc(),
            e = this.getFirstEntry();
        if (e !== null) {
            for (t.add(e); (e = Gi.successor(e)) !== null;) t.add(e);
        }
        return t;
        ...
        if (t.right !== null) {
            for (var e = t.right; e.left !== null;) e = e.left;
            return e;
        }
        for (var n = t.parent, r = t; n !== null && r === n.right;) r = n, n = n.parent;
        return n;
    ...
    Dc.prototype.interfaces_ = function () {
        ...
        for (var e = 0, n = this.array_.length; e < n; e++) {
            if (this.array_[e].compareTo(t) === 0) return !0;
        }
        return !1;
    }, ki.prototype.add = function (t) {
        if (this.contains(t)) return !1;
        for (var e = 0, n = this.array_.length; e < n; e++) {
            if (this.array_[e].compareTo(t) === 1) return this.array_.splice(e, 0, t), !0;
        }
    ...
    Uc.prototype.boundaryMultiLineString = function (t) {
        ...
        for (var n = 0; n < t.getNumGeometries(); n++) {
            ...
            r.getNumPoints() !== 0 && (this.addEndpoint(r.getCoordinateN(0)), this.addEndpoint(r.getCoordinateN(r.getNumPoints() - 1)));
        }
        ...
        e === null && (e = new Yc(), this._endpointMap.put(t, e)), e.count++;
    ...
    Vc.prototype.interfaces_ = function () {
        ...
        if (arguments.length === 2) {
            for (var r = arguments[0], i = arguments[1], o = '', s = new function () {}(new function () {}(Vc.getStackTrace(r))), a = 0; a < i; a++) {
                try {
    ...
    Wc.prototype.interfaces_ = function () {
        ...
        var e = t.size();
        return e === 0 || !(e <= 3) && (t.getOrdinate(0, Bu.X) === t.getOrdinate(e - 1, Bu.X) && t.getOrdinate(0, Bu.Y) === t.getOrdinate(e - 1, Bu.Y));
        ...
        var r = t.create(n, e.getDimension()),
            i = e.size();
        if (Wc.copy(e, 0, r, 0, i), i > 0) {
            for (var o = i; o < n; o++) Wc.copy(e, i - 1, r, o, 1);
        }
        return r;
    ...
    var Jc = (function (t) {
            ...
            return e.prototype.computeEnvelopeInternal = function () {
                ...
                if (t === null && (t = this.getFactory().getCoordinateSequenceFactory().create([])), t.size() === 1) throw new _u('Invalid number of points in LineString (found ' + t.size() + ' - must be 0 or >= 2)');
                this._points = t;
    ...
    var Kc = (function (t) {
            ...
            return e.prototype.computeEnvelopeInternal = function () {
                ...
                t === null && (t = this.getFactory().getCoordinateSequenceFactory().create([])), tc.isTrue(t.size() <= 1), this._coordinates = t;
    ...
    var $c = (function (t) {
            function e (e, n, r) {
                if (t.call(this, r), this._shell = null, this._holes = null, e === null && (e = this.getFactory().createLinearRing()), n === null && (n = []), t.hasNullElements(n)) throw new _u('holes must not contain null elements');
            ...
            return e.prototype.computeEnvelopeInternal = function () {
                ...
                if (this.getNumInteriorRing() !== 0) return !1;
                if (this._shell === null) return !1;
                if (this._shell.getNumPoints() !== 5) return !1;
    ...
    rh.prototype.setCopyUserData = function (t) {
        ...
        return this._factory === null && (this._factory = t.getFactory()), t instanceof jc ? this.editGeometryCollection(t, e) : t instanceof $c ? this.editPolygon(t, e) : t instanceof Kc ? e.edit(t, this._factory) : t instanceof Jc ? e.edit(t, this._factory) : (tc.shouldNeverReachHere('Unsupported Geometry class: ' + t.getClass().getName()), null);
        ...
        if (n === null && (n = this._factory.createPolygon(null)), n.isEmpty()) return n;
        var r = this.edit(n.getExteriorRing(), e);
        if (r === null || r.isEmpty()) return this._factory.createPolygon();
    ...
    sh.prototype.edit = function (t, e) {
        ...
        return n === null ? t : t instanceof eh ? e.createLinearRing(n) : t instanceof Jc ? e.createLineString(n) : t instanceof Kc ? n.length > 0 ? e.createPoint(n[0]) : e.createPoint() : t;
    ...
    var uh = function () {
            if (this._dimension = 3, this._coordinates = null, arguments.length === 1) {
                if (arguments[0] instanceof Array) this._coordinates = arguments[0], this._dimension = 3;
                    ...
                    var n = arguments[0];
                    if (n === null) return this._coordinates = new Array(0).fill(null), null;
                ...
                if (arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
                    var i = arguments[0],
                        o = arguments[1];
                    this._coordinates = i, this._dimension = o, i === null && (this._coordinates = new Array(0).fill(null));
                }
    ...
    var ph = (function (t) {
        ...
        fh = function t () {
            if (this._modelType = null, this._scale = null, arguments.length === 0) this._modelType = t.FLOATING;
            else if (arguments.length === 1) {
    ...
    var _h = function t () {
            this._precisionModel = new fh(), this._SRID = 0, this._coordinateSequenceFactory = t.getDefaultCoordinateSequenceFactory(), arguments.length === 0 || (arguments.length === 1 ? Lu(arguments[0], Cu) ? this._coordinateSequenceFactory = arguments[0] : arguments[0] instanceof fh && (this._precisionModel = arguments[0]) : arguments.length === 2 ? (this._precisionModel = arguments[0], this._SRID = arguments[1]) : arguments.length === 3 && (this._precisionModel = arguments[0], this._SRID = arguments[1], this._coordinateSequenceFactory = arguments[2]));
        },
        mh = {
            serialVersionUID: {
                configurable: !0
    ...
    _h.prototype.toGeometry = function (t) {
        ...
        if (arguments.length === 0) return new Xc(null, this);
        if (arguments.length === 1) {
            var t = arguments[0];
        ...
        for (var e = null, n = !1, r = !1, i = t.iterator(); i.hasNext();) {
            var o = i.next(),
                s = o.getClass();
            e === null && (e = s), s !== e && (n = !0), o.isGeometryCollectionOrDerived() && (r = !0);
        }
        ...
        if (arguments.length === 0) return new $c(null, null, this);
        if (arguments.length === 1) {
            if (Lu(arguments[0], Bu)) {
                var t = arguments[0];
        ...
        if (arguments.length === 0) return new jc(null, this);
        if (arguments.length === 1) {
            var t = arguments[0];
        ...
        if (arguments.length === 0) return new nh(null, this);
        if (arguments.length === 1) {
            var t = arguments[0];
            return new nh(t, this);
        }
    }, _h.prototype.createMultiPoint = function () {
        if (arguments.length === 0) return new th(null, this);
        if (arguments.length === 1) {
            if (arguments[0] instanceof Array) {
                var t = arguments[0];
    ...
    xh.prototype.read = function (t) {
        ...
        return vh.indexOf(n) !== -1 ? Eh[n].apply(this, [e.coordinates]) : n === 'GeometryCollection' ? Eh[n].apply(this, [e.geometries]) : Eh[n].apply(this, [e]);
    ...
    Nh.prototype.interfaces_ = function () {
        ...
        if (this.array_.length === 0) throw new ji();
    ...
    Sh.prototype.getCoordinate = function () {
        ...
        tc.isTrue(this._minIndex !== 0 || this._minCoord.equals(this._minDe.getCoordinate()), 'inconsistency in rightmost processing'), this._minIndex === 0 ? this.findRightmostEdgeAtNode() : this.findRightmostEdgeAtVertex(), this._orientedDe = this._minDe;
    ...
    Ph.prototype.clearVisitedEdges = function () {
        ...
        if (e === null) throw new Mh('unable to find edge to compute depths at ' + t.getCoordinate());
    ...
    Rh.prototype.getGeometryCount = function () {
        ...
        for (var e = 0; e < 2; e++) this.elt[e] === null && t.elt[e] !== null ? this.elt[e] = new Oh(t.elt[e]) : this.elt[e].merge(t.elt[e]);
    ...
    Th.prototype.computeRing = function () {
        ...
        var e = t,
            n = !0;
        do {
            if (e === null) throw new Mh('Found null DirectedEdge');
    ...
    var qh = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.isIncidentEdgeInResult = function () {
                ...
                if (arguments.length !== 2) return t.prototype.setLabel.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1];
                this._label === null ? this._label = new Rh(e, n) : this._label.setLocation(e, n);
    ...
    Bh.prototype.interfaces_ = function () {
        ...
        if (typeof arguments[0] === 'number' && typeof arguments[1] === 'number') {
            var t = arguments[0],
                e = arguments[1];
            if (t === 0 && e === 0) throw new _u('Cannot compute the quadrant for point ( ' + t + ', ' + e + ' )');
    ...
    zh.prototype.compareDirection = function (t) {
        ...
        this._p0 = t, this._p1 = e, this._dx = e.x - t.x, this._dy = e.y - t.y, this._quadrant = Bh.quadrant(this._dx, this._dy), tc.isTrue(!(this._dx === 0 && this._dy === 0), 'EdgeEnd with identical endpoints found');
    ...
    var jh = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getNextMin = function () {
                ...
                if (this._depth[t] !== -999 && this._depth[t] !== e) throw new Mh('assigned depths do not match', this.getCoordinate());
                this._depth[t] = e;
    ...
    var Uh = function () {
        if (this._edges = new bc(), this._nodes = null, this._edgeEndList = new bc(), arguments.length === 0) this._nodes = new Gh(new Xh());
        else if (arguments.length === 1) {
            var t = arguments[0];
    ...
    Uh.prototype.printEdges = function (t) {
        ...
        if (n === null) return !1;
        var r = n.getLabel();
        return r !== null && r.getLocation(t) === Su.BOUNDARY;
    ...
    Yh.prototype.sortShellsAndHoles = function (t, e, n) {
        ...
        for (var n = e.iterator(); n.hasNext();) {
            ...
            if (r.getShell() === null) {
                ...
                if (i === null) throw new Mh('unable to assign hole to a shell', r.getCoordinate(0));
                r.setShell(i);
            }
        }
        ...
        for (var r = new bc(), i = t.iterator(); i.hasNext();) {
            ...
            if (o.getMaxNodeDegree() > 2) {
                ...
                var s = o.buildMinimalRings(),
                    a = this.findShell(s);
                a !== null ? (this.placePolygonHoles(a, s), e.add(a)) : n.addAll(s);
            }
            else r.add(o);
        }
        return r;
        ...
        for (var n = t.getLinearRing(), r = n.getEnvelopeInternal(), i = n.getCoordinateN(0), o = null, s = null, a = e.iterator(); a.hasNext();) {
            ...
            var l = !1;
            h.contains(r) && sc.isPointInRing(i, c.getCoordinates()) && (l = !0), l && (o === null || s.contains(h)) && (o = u);
        }
        return o;
    ...
    var Kh = function () {
            if (this._childBoundables = new bc(), this._bounds = null, this._level = null, arguments.length === 0);
            else if (arguments.length === 1) {
                var t = arguments[0];
                this._level = t;
            }
    ...
    Kh.prototype.getLevel = function () {
        ...
        tc.isTrue(this._bounds === null), this._childBoundables.add(t);
    ...
    var el = function t () {
            if (this._root = null, this._built = !1, this._itemBoundables = new bc(), this._nodeCapacity = null, arguments.length === 0) {
    ...
    el.prototype.getNodeCapacity = function () {
        ...
        if (arguments.length === 3) {
            ...
            for (var o = r.getChildBoundables().iterator(); o.hasNext();) {
                var s = o.next();
                s instanceof Kh ? this.boundablesAtLevel(n, s, i) : (tc.isTrue(s instanceof Hh), n === -1 && i.add(s));
            }
            return null;
        }
        ...
        if (arguments.length === 3) {
            ...
            return s !== null && s.getChildBoundables().isEmpty() && r.getChildBoundables().remove(s), o;
        }
    ...
    var ol = (function (t) {
            ...
            return e.prototype.createParentBoundablesFromVerticalSlices = function (t, e) {
                ...
                return arguments.length === 0 ? t.prototype.size.call(this) : t.prototype.size.apply(this, arguments);
            }, e.prototype.insert = function () {
                if (arguments.length !== 2) return t.prototype.insert.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1];
                if (e.isNull()) return null;
                ...
                return arguments.length === 0 ? t.prototype.depth.call(this) : t.prototype.depth.apply(this, arguments);
                ...
                if (arguments.length === 1) {
                    ...
                    if (arguments[0] instanceof tl && typeof arguments[1] === 'number') {
                        var a = arguments[0],
                            u = arguments[1],
                            c = null,
                            h = new Wh();
        ...
        sl = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.computeBounds = function () {
                for (var t = null, e = this.getChildBoundables().iterator(); e.hasNext();) {
                    var n = e.next();
                    t === null ? t = new Yu(n.getBounds()) : t.expandToInclude(n.getBounds());
                }
                return t;
            }, e.prototype.interfaces_ = function () {
                return [];
    ...
    cl.prototype.getSplitCoordinates = function () {
        ...
        return e.isInterior() || r--, r === 1 && (n[0] = t.segmentIndex + 1, !0);
        ...
        return r !== null ? (tc.isTrue(r.coord.equals2D(t), 'Found equal nodes with different coordinates'), r) : (this._nodeMap.put(n, n), n);
    ...
    hl.prototype.interfaces_ = function () {
        ...
        if (typeof arguments[0] === 'number' && typeof arguments[1] === 'number') {
            var t = arguments[0],
                e = arguments[1];
            if (t === 0 && e === 0) throw new _u('Cannot compute the octant for point ( ' + t + ', ' + e + ' )');
            var n = Math.abs(t),
                r = Math.abs(e);
        ...
        if (arguments[0] instanceof bu && arguments[1] instanceof bu) {
            var i = arguments[0],
                ...
                s = o.x - i.x,
                a = o.y - i.y;
            if (s === 0 && a === 0) throw new _u('Cannot compute the octant for two identical points ' + i);
    ...
    var gl = function () {
            if (this.p0 = null, this.p1 = null, arguments.length === 0) this.p0 = new bu(), this.p1 = new bu();
            else if (arguments.length === 1) {
                var t = arguments[0];
    ...
    var El = (function (t) {
        ...
        wl = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.overlap = function () {
                if (arguments.length !== 4) return t.prototype.overlap.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1],
                    r = arguments[2],
                    i = arguments[3],
        ...
        bl = function t () {
            if (this._quadrantSegments = t.DEFAULT_QUADRANT_SEGMENTS, this._endCapStyle = t.CAP_ROUND, this._joinStyle = t.JOIN_ROUND, this._mitreLimit = t.DEFAULT_MITRE_LIMIT, this._isSingleSided = !1, this._simplifyFactor = t.DEFAULT_SIMPLIFY_FACTOR, arguments.length === 0);
            else if (arguments.length === 1) {
                var e = arguments[0];
    ...
    bl.prototype.getEndCapStyle = function () {
        ...
        this._quadrantSegments = t, this._quadrantSegments === 0 && (this._joinStyle = bl.JOIN_BEVEL), this._quadrantSegments < 0 && (this._joinStyle = bl.JOIN_MITRE, this._mitreLimit = Math.abs(this._quadrantSegments)), t <= 0 && (this._quadrantSegments = 1), this._joinStyle !== bl.JOIN_ROUND && (this._quadrantSegments = bl.DEFAULT_QUADRANT_SEGMENTS);
    ...
    Tl.prototype.getOffsetCurve = function (t, e) {
        ...
        if (n === 0) return Tl.copyCoordinates(t);
    ...
    Fl.prototype.compareTo = function (t) {
        ...
        return n !== 0 ? n : (n = -1 * e._upwardSeg.orientationIndex(this._upwardSeg)) != 0 ? n : this._upwardSeg.compareTo(e._upwardSeg);
    ...
    ql.prototype.area = function () {
        ...
        if (t === null) throw new _u('Supplied point is null.');
    ...
    Gl.prototype.addPoint = function (t) {
        ...
        if (e === 0 && t.length < eh.MINIMUM_VALID_SIZE) return null;
        var o = r,
            s = i;
    ...
    jl.prototype.getNextCW = function (t) {
        ...
        return this._edgeList === null && (this._edgeList = new bc(this._edgeMap.values())), this._edgeList;
        ...
        for (var e = [!1, !1], n = this.iterator(); n.hasNext();) {
            for (var r = n.next().getLabel(), i = 0; i < 2; i++) r.isLine(i) && r.getLocation(i) === Su.BOUNDARY && (e[i] = !0);
        }
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.linkResultDirectedEdges = function () {
                ...
                for (var t = null, e = null, n = this._SCANNING_FOR_INCOMING, r = 0; r < this._resultAreaEdgeList.size(); r++) {
                    ...
                    if (i.getLabel().isArea()) {
                        switch (t === null && i.isInResult() && (t = i), n) {
                ...
                if (n === this._LINKING_TO_OUTGOING) {
                    if (t === null) throw new Mh('no outgoing dirEdge found', this.getCoordinate());
                ...
                var r = t.get(e - 1),
                    i = n.getQuadrant(),
                    o = r.getQuadrant();
                return Bh.isNorthern(i) && Bh.isNorthern(o) ? n : Bh.isNorthern(i) || Bh.isNorthern(o) ? n.getDy() !== 0 ? n : r.getDy() !== 0 ? r : (tc.shouldNeverReachHere('found two horizontal edges incident on node'), null) : r;
            }, e.prototype.print = function (t) {
                ...
                for (var t = null, e = null, n = this._edgeList.size() - 1; n >= 0; n--) {
                    var r = this._edgeList.get(n),
                        i = r.getSym();
                    e === null && (e = i), t !== null && i.setNext(t), t = r;
                }
                e.setNext(t);
                ...
                for (var e = null, n = null, r = this._SCANNING_FOR_INCOMING, i = this._resultAreaEdgeList.size() - 1; i >= 0; i--) {
                    var o = this._resultAreaEdgeList.get(i),
                        s = o.getSym();
                    switch (e === null && o.getEdgeRing() === t && (e = o), r) {
                    case this._SCANNING_FOR_INCOMING:
                ...
                r === this._LINKING_TO_OUTGOING && (tc.isTrue(e !== null, 'found null for first outgoing dirEdge'), tc.isTrue(e.getEdgeRing() === t, 'unable to link last incoming dirEdge'), n.setNextMin(e));
    ...
    Yl.prototype.compareTo = function (t) {
        ...
        return Cc.increasingDirection(t) === 1;
    ...
    Zl.prototype.print = function (t) {
        ...
        return i !== null ? i : (this._nodeMap.put(r, r), r);
    ...
    $l.prototype.getDepth = function (t, e) {
        ...
        if (arguments.length === 0) {
            for (var t = 0; t < 2; t++) {
                for (var e = 0; e < 3; e++) {
                    if (this._depth[t][e] !== $l.NULL_VALUE) return !1;
                }
            }
            return !0;
        }
    ...
    var ep = (function (t) {
            function e () {
                if (t.call(this), this.pts = null, this._env = null, this.eiList = new Zl(this), this._name = null, this._mce = null, this._isIsolated = !0, this._depth = new $l(), this._depthDelta = 0, arguments.length === 1) {
                    var n = arguments[0];
                    e.call(this, n, null);
                }
                else if (arguments.length === 2) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.getDepth = function () {
                ...
                return this._mce === null && (this._mce = new Ql(this)), this._mce;
                ...
                if (arguments.length !== 2) return t.prototype.updateIM.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1];
    ...
    rp.prototype.rescale = function () {
        if (Lu(arguments[0], vc)) {
            ...
            n.length === 2 && n[0].equals2D(n[1]) && Xu.out.println(n);
        }
        ...
        if (arguments.length === 0) {
            ...
            for (var n = arguments[0], r = arguments[1].iterator(); r.hasNext();) {
                for (var i = r.next().getCoordinates(), o = 1; o < i.length - 1; o++) {
                    if (i[o].equals(n)) throw new Qu('found endpt/interior pt intersection at index ' + o + ' :pt ' + n);
                }
            }
        }
    ...
    var sp = function () {
            ...
            e !== 1 && (this._pt = new bu(this.scale(t.x), this.scale(t.y)), this._p0Scaled = new bu(), this._p1Scaled = new bu()), this.initCorners(this._pt);
        },
        ap = {
    ...
    sp.prototype.intersectsScaled = function (t, e) {
        ...
        this._minx = t.x - 0.5, this._maxx = t.x + 0.5, this._miny = t.y - 0.5, this._maxy = t.y + 0.5, this._corner[0] = new bu(this._maxx, this._maxy), this._corner[1] = new bu(this._minx, this._maxy), this._corner[2] = new bu(this._minx, this._miny), this._corner[3] = new bu(this._maxx, this._miny);
    ...
    var lp = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.isNodeAdded = function () {
                ...
                if (arguments.length !== 2) return t.prototype.select.apply(this, arguments);
                var e = arguments[0],
                    n = arguments[1],
                    r = e.getContext();
                if (this._parentEdge !== null && r === this._parentEdge && n === this._hotPixelVertexIndex) return null;
    ...
    var gp = function () {
            if (this._argGeom = null, this._distance = null, this._bufParams = new bl(), this._resultGeometry = null, this._saveException = null, arguments.length === 1) {
                var t = arguments[0];
                this._argGeom = t;
            }
            else if (arguments.length === 2) {
    ...
    gp.prototype.bufferFixedPrecision = function (t) {
        ...
        if (arguments.length === 0) {
            for (var e = gp.MAX_PRECISION_DIGITS; e >= 0; e--) {
                ...
                if (t._resultGeometry !== null) return null;
            }
        ...
        if (arguments.length === 3) {
            if (Number.isInteger(arguments[2]) && arguments[0] instanceof cc && typeof arguments[1] === 'number') {
                var n = arguments[0],
                    r = arguments[1],
                    i = arguments[2],
                    o = new gp(n);
            ...
            if (arguments[2] instanceof bl && arguments[0] instanceof cc && typeof arguments[1] === 'number') {
                var s = arguments[0],
                    a = arguments[1],
                    u = arguments[2];
    ...
    _p.prototype.interfaces_ = function () {
        ...
        if (arguments[2] instanceof yp && arguments[0] instanceof Jc && arguments[1] instanceof bu) {
            for (var t = arguments[0], e = arguments[1], n = arguments[2], r = t.getCoordinates(), i = new gl(), o = 0; o < r.length - 1; o++) {
    ...
    bp.prototype.filter = function (t) {
        ...
        if (arguments.length === 2) {
            ...
            if (arguments[0] instanceof cc && typeof arguments[1] === 'boolean') {
                var o = arguments[0],
                    s = arguments[1],
                    a = new bc();
            ...
            if (typeof arguments[2] === 'boolean' && Lu(arguments[0], vc) && Lu(arguments[1], vc)) {
            ...
            if (typeof arguments[2] === 'boolean' && arguments[0] instanceof cc && Lu(arguments[1], vc)) {
                var d = arguments[0],
                    y = arguments[1],
                    _ = arguments[2];
    ...
    var Ip = function () {
        if (this._boundaryRule = fc.OGC_SFS_BOUNDARY_RULE, this._isIn = null, this._numBoundaries = null, arguments.length === 0);
        else if (arguments.length === 1) {
            var t = arguments[0];
            if (t === null) throw new _u('Rule must be non-null');
    ...
    Ip.prototype.locateInternal = function () {
        ...
        if (e instanceof Kc && this.updateLocationInfo(this.locateInternal(t, e)), e instanceof Jc) this.updateLocationInfo(this.locateInternal(t, e));
    ...
    var Lp = function () {
        if (this._geom = null, this._terminateDistance = 0, this._ptLocator = new Ip(), this._minDistanceLocation = null, this._minDistance = mu.MAX_VALUE, arguments.length === 2) {
            var t = arguments[0],
                e = arguments[1];
    ...
    Lp.prototype.computeContainmentDistance = function () {
        ...
        if (arguments.length === 0) {
            ...
            if (arguments[2] instanceof Array && arguments[0] instanceof Jc && arguments[1] instanceof Kc) {
                var t = arguments[0],
                    e = arguments[1],
                    n = arguments[2];
        ...
        if (this._geom[0] === null || this._geom[1] === null) throw new _u('null geometries are not supported');
    ...
    Op.prototype.interfaces_ = function () {
        ...
        if (arguments[2] instanceof Pp && arguments[0] instanceof Jc && arguments[1] instanceof bu) {
            for (var t = arguments[0], e = arguments[1], n = arguments[2], r = new gl(), i = t.getCoordinates(), o = 0; o < i.length - 1; o++) {
    ...
    Vp.prototype.filterCoveredNodeToPoint = function (t) {
        ...
        for (var e = this._op.getGraph().getNodes().iterator(); e.hasNext();) {
            var n = e.next();
            if (!n.isInResult() && (!n.isIncidentEdgeInResult() && (n.getEdges().getDegree() === 0 || t === Cf.INTERSECTION))) {
                var r = n.getLabel();
    ...
    Hp.prototype.transformPoint = function (t, e) {
        ...
        for (var n = new bc(), r = 0; r < t.getNumGeometries(); r++) {
            ...
            i !== null && (this._pruneEmptyGeometry && i.isEmpty() || n.add(i));
        }
    ...
    var Wp = function t () {
        if (this._snapTolerance = 0, this._srcPts = null, this._seg = new gl(), this._allowSnappingToSourceVertices = !1, this._isClosed = !1, arguments[0] instanceof Jc && typeof arguments[1] === 'number') {
            var e = arguments[0],
                n = arguments[1];
    ...
    Wp.prototype.snapVertices = function (t, e) {
        for (var n = this._isClosed ? t.size() - 1 : t.size(), r = 0; r < n; r++) {
            ...
            o !== null && (t.set(r, new bu(o)), r === 0 && this._isClosed && t.set(t.size() - 1, new bu(o)));
        }
    ...
    af.prototype.isDelete = function () {
        ...
        return this._label !== null && this._label === t._label;
    ...
    hf.prototype.isTrivialIntersection = function (t, e, n, r) {
        ...
        return e !== null && (!!this.isBoundaryPointInternal(t, e[0]) || !!this.isBoundaryPointInternal(t, e[1]));
    ...
    var lf = (function (t) {
            ...
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.prepareEvents = function () {
                ...
                if (arguments.length === 1) {
                    ...
                    else if (typeof arguments[2] === 'boolean' && Lu(arguments[0], wc) && arguments[1] instanceof hf) {
                        var s = arguments[0],
                            a = arguments[1];
    ...
    _f.prototype.buildTree = function () {
        ...
        for (var n = 0; n < t.size(); n += 2) {
            var r = t.get(n);
            if ((n + 1 < t.size() ? t.get(n) : null) === null) e.add(r);
            else {
    ...
    var bf = (function (t) {
            function e () {
                if (t.call(this), this._parentGeom = null, this._lineEdgeMap = new ph(), this._boundaryNodeRule = null, this._useBoundaryDeterminationRule = !0, this._argIndex = null, this._boundaryNodes = null, this._hasTooFewPoints = !1, this._invalidPoint = null, this._areaPtLocator = null, this._ptLocator = new Ip(), arguments.length === 2) {
                    var e = arguments[0],
                        n = arguments[1],
                    ...
                    var i = arguments[0],
                        o = arguments[1],
                        s = arguments[2];
                    this._argIndex = i, this._parentGeom = o, this._boundaryNodeRule = s, o !== null && this.add(o);
                }
            }
            return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.insertBoundaryPoint = function (t, n) {
                ...
                var r = this._nodes.addNode(e),
                    i = r.getLabel();
                i === null ? r._label = new Rh(t, n) : i.setLocation(t, n);
                ...
                if (arguments.length !== 1) return t.prototype.add.apply(this, arguments);
                var e = arguments[0];
                if (e.isEmpty()) return null;
                if (e instanceof nh && (this._useBoundaryDeterminationRule = !1), e instanceof $c) this.addPolygon(e);
                ...
                return Lu(this._parentGeom, Qc) && this._parentGeom.getNumGeometries() > 50 ? (this._areaPtLocator === null && (this._areaPtLocator = new vf(this._parentGeom)), this._areaPtLocator.locate(t)) : this._ptLocator.locate(t, this._parentGeom);
        ...
        If = function () {
            if (this._li = new rc(), this._resultPrecisionModel = null, this._arg = null, arguments.length === 1) {
                var t = arguments[0];
    ...
    var Cf = (function (t) {
        ...
        return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.insertUniqueEdge = function (t) {
            ...
            for (var t = this._edgeList.iterator(); t.hasNext();) {
                ...
                if (!r.isNull()) {
                    r.normalize();
                    for (var i = 0; i < 2; i++) n.isNull(i) || !n.isArea() || r.isNull(i) || (r.getDelta(i) === 0 ? n.toLine(i) : (tc.isTrue(!r.isNull(i, Nh.LEFT), 'depth of LEFT side has not been initialized'), n.setLocation(i, Nh.LEFT, r.getLocation(i, Nh.LEFT)), tc.isTrue(!r.isNull(i, Nh.RIGHT), 'depth of RIGHT side has not been initialized'), n.setLocation(i, Nh.RIGHT, r.getLocation(i, Nh.RIGHT))));
                }
            }
    ...
    var Tf = function () {
            ...
            var t = arguments[0];
            this._inputPolys = t, this._inputPolys === null && (this._inputPolys = new bc());
        },
        Af = {
    ...
    Tf.prototype.reduceToGeometries = function (t) {
        ...
        return e.size() === 1 ? e.get(0) : t.getFactory().createMultiPolygon(_h.toPolygonArray(e));
    ...
    var ig = function (t) {
                        ...
                        polygonEnd: function () {
                            ...
                            var t = (function (t, e) {
                                ...
                                for (var a = 0, u = t.length; a < u; ++a) {
                                    if (h = (c = t[a]).length) {
                                        for (var c, h, l = c[h - 1], p = l[0], f = l[1] / 2 + zf, g = Kf(f), d = Wf(f), y = 0; y < h; ++y, p = m, g = x, d = E, l = _) {
                                            var _ = c[y],
                                                m = _[0],
                                                v = _[1] / 2 + zf,
                                                x = Kf(v),
        ...
        Eg = xg(function () {
            ...
            var i;
            if (t == null) i = n * kf, r.point(-Bf, i), r.point(0, i), r.point(Bf, i), r.point(Bf, 0), r.point(Bf, -i), r.point(0, -i), r.point(-Bf, -i), r.point(-Bf, 0), r.point(-Bf, i);
            ...
            return xg(n, function (t) {
                ...
                return {
                    ...
                    point: function (l, p) {
                        ...
                        if (!e && (c = u = d) && t.lineStart(), d !== u && (!(f = r(e, g)) || ag(e, f) || ag(g, f)) && (g[0] += Gf, g[1] += Gf, d = n(g[0], g[1])), d !== u) h = 0, d ? (t.lineStart(), f = r(g, e), t.point(f[0], f[1])) : (f = r(e, g), t.point(f[0], f[1]), t.lineEnd()), e = f;
                        else if (a && e && s ^ d) {
                            var _;
                ...
                !(function (t, e, n, r, i, o) {
                    if (n) {
                        var s = Wf(e),
                            a = Kf(e),
                            u = r * n;
                        i == null ? (i = e + r * jf, o = e - u / 2) : (i = ho(s, i), o = ho(s, o), (r > 0 ? i < o : i > o) && (i += r * jf));
                ...
                function n (r, i, o, s, a, u, c, h, l, p, f, g, d, y) {
                    ...
                    if (v > 4 * e && d--) {
                        var x = s + p,
                            ...
                            P = M - i,
                            O = m * L - _ * P;
                        (O * O / v > e || Yf((_ * L + m * P) / v - 0.5) > 0.3 || s * p + a * f + u * g < Ig) && (n(r, i, o, s, a, u, S, M, N, x /= b, E /= b, w, d, y), y.point(S, M), n(S, M, N, x, E, w, c, h, l, p, f, g, d, y));
                    }
                }
                return function (e) {
                    function r (n, r) {
    ...
    var Sg = function () {
        var t = (function (t) {
                ...
                return o.scale = function (t) {
                    ...
                    return arguments.length ? (t == null ? h = n = r = i = null : (h = +t[0][0], n = +t[0][1], r = +t[1][0], i = +t[1][1]), e()) : h == null ? null : [
                        [h, n],
                        [r, i]
                    ];
                }, e();
    ...
    t.projection = Cs, t.random = gu, t.clusters = du, t.helpers = ko, t.invariant = jo, t.meta = zo, t.isolines = function (t, e, n) {
        ...
        var o = $t(i, n);
        return o.coordinates.length === 1 && (o.coordinates = o.coordinates[0], o.type = 'Polygon'), e(o);
        ...
        if (e === null || void 0 === e) throw new Error('num is required');
        ...
        if (!t.geometry || t.geometry.type !== 'Polygon' && t.geometry.type !== 'MultiPolygon') throw new Error('input must be a Polygon or MultiPolygon');
        var e = {
            type: 'FeatureCollection',
            features: []
        };
        return t.geometry.type === 'Polygon' ? e.features = De(t.geometry.coordinates) : t.geometry.coordinates.forEach(function (t) {
        ...
        if (!e) throw new Error('line is required');
        if (K(e) !== 'LineString') throw new Error('line must be a LineString');
        var o = 1 / 0,
            s = null;
        return O(t, function (t) {
            var n = gn(t, e, {
        ...
        if ((n = t.type === 'Feature' ? t.geometry : t).type === 'LineString') e = [n.coordinates];
        else if (n.type === 'MultiLineString') e = n.coordinates;
        else if (n.type === 'MultiPolygon') e = [].concat.apply([], n.coordinates);
        else {
            if (n.type !== 'Polygon') throw new Error('Input must be a LineString, MultiLineString, Polygon, or MultiPolygon Feature or Geometry');
            e = n.coordinates;
        }
            ...
            e.forEach(function (e) {
                for (var n = 0; n < t.length - 1; n++) {
                    for (var o = n; o < e.length - 1; o++) {
                        if (t === e) {
                            if (Math.abs(n - o) === 1) continue;
                            if (n === 0 && o === t.length - 2 && t[n][0] === t[t.length - 1][0] && t[n][1] === t[t.length - 1][1]) continue;
                        }
                        var s = (function (t, e, n, r, i, o, s, a) {
                            ...
                            return (u = (a - o) * (n - t) - (s - i) * (r - e)) == 0 ? f.x !== null && f.y !== null && f : (c = e - o, h = t - i, l = (s - i) * c - (a - o) * h, p = (n - t) * c - (r - e) * h, c = l / u, h = p / u, f.x = t + c * (n - t), f.y = e + c * (r - e), c >= 0 && c <= 1 && (f.onLine1 = !0), h >= 0 && h <= 1 && (f.onLine2 = !0), !(!f.onLine1 || !f.onLine2) && [f.x, f.y]);
        ...
        var r = U(n);
        if (K(n) !== 'LineString') throw new Error('line must be a LineString');
        ...
        var e = [];
        return F(t, function (t) {
            t.geometry.type === 'Polygon' && O(Ls(t), function (n) {
        ...
        case 'MultiLineString':
            var s = [];
            return n === 'LineString' && (r = [r]), r.forEach(function (t) {
                Gs(t, e, s);
            }), s.length === 1 ? a(s[0], i) : h(s, i);
        case 'Polygon':
            return o(Wn(r, e), i);
        case 'MultiPolygon':
        ...
        var n = e.reverse || !1,
            r = e.mutate || !1;
        if (!t) throw new Error('<geojson> is required');
        if (typeof n !== 'boolean') throw new Error('<reverse> must be a boolean');
        if (typeof r !== 'boolean') throw new Error('<mutate> must be a boolean');
        !1 === r && (t = Gt(t));
        var i = [];
        switch (t.type) {
        case 'GeometryCollection':
        ...
        var i = r.units,
            ...
            s = r.mutate;
        if (!t) throw new Error('geojson is required');
        if (void 0 === e || e === null || isNaN(e)) throw new Error('distance is required');
        if (o && typeof o !== 'number' && isNaN(o)) throw new Error('zTranslation is not a number');
        if (o = void 0 !== o ? o : 0, e === 0 && o === 0) return t;
        if (void 0 === n || n === null || isNaN(n)) throw new Error('direction is required');
        return e < 0 && (e = -e, n = -n), !1 !== s && void 0 !== s || (t = Gt(t)), S(t, function (t) {
            var r = U(nr(t, e, n, {
                units: i
            }));
            t[0] = r[0], t[1] = r[1], o && t.length === 3 && (t[2] += o);
        }), t;
                    ...
                    if (nn(t, e).features.length > 0) {
                        for (var n = 0; n < t.coordinates.length - 1; n++) {
                            for (var r = 0; r < e.coordinates.length - 1; r++) {
                                var i = !0;
                                if (r !== 0 && r !== e.coordinates.length - 2 || (i = !1), Lr(t.coordinates[n], t.coordinates[n + 1], e.coordinates[r], i)) return !0;
                            }
                        }
                    }
                    return !1;
        ...
        var r = n.minPoints,
            i = n.units;
        if (W(t, 'Point', 'Input must contain Points'), e === null || void 0 === e) throw new Error('maxDistance is required');
        if (!(Math.sign(e) > 0)) throw new Error('Invalid maxDistance');
        if (!(void 0 === r || r === null || Math.sign(r) > 0)) throw new Error('Invalid minPoints');
        t = Gt(t), r = r || 3;
        var o = new Ha.DBSCAN(),
            s = -1;
        ...
        if (typeof (e = e || {}) !== 'object') throw new Error('options is invalid');
        ...
        if (Dr(t, 'line1') !== 'LineString') throw new Error('line1 must be a LineString');
        if (Dr(e, 'line2') !== 'LineString') throw new Error('line2 must be a LineString');
        ...
        case 'FeatureCollection':
            if (u.features.length === 0) return a([h, l]);
            break;
        case 'Polygon':
            u = c([e(J(u))]);
            break;
        ...
        var n = (function (t) {
                return o(t && t.geometry.coordinates || [
                    [
                        [180, 90],
                        [-180, 90],
                        [-180, -90],
        ...
        if (void 0 !== o && typeof o !== 'number') throw new Error('weight must be a number');
