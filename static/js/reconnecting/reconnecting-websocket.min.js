!(function (a, b) {
    ...
    function a (b, c, d) {
        function l (a, b) {
        ...
        } var e = {debug: !1, automaticOpen: !0, reconnectInterval: 1e3, maxReconnectInterval: 3e4, reconnectDecay: 1.5, timeoutInterval: 2e3}; d || (d = {}); for (var f in e) this[f] = typeof d[f] !== 'undefined' ? d[f] : e[f]; this.url = b, this.reconnectAttempts = 0, this.readyState = WebSocket.CONNECTING, this.protocol = null; var h, g = this, i = !1, j = !1, k = document.createElement('div'); k.addEventListener('open', function (a) {
            g.onopen(a);
            ...
            h = new WebSocket(g.url, c || []), b || k.dispatchEvent(l('connecting')), (g.debug || a.debugAll) && console.debug('ReconnectingWebSocket', 'attempt-connect', g.url); var d = h, e = setTimeout(function () {
